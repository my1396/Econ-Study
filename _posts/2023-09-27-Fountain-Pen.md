...
- 78G 推荐，笔尖采用 不锈钢镀金。只是金色而已，本质是刚尖。
  ...
  Pilot **CON-40 converter** is included though you may choose to use a compatible Pilot ink cartridge.
...
Q: 怎么把瓶里的钢笔水用完? 剩下一些怎么也吸不上来? 怎么办?  
A: 1. 瓶里的钢笔水吸不上来的原因是钢笔水的深度不足以完全浸没钢笑头,因此要解决这个问题,可以把瓶里的钢笔水倒入另一个能插入钢笔头的较细容器.这样用钢笔在较细的容器中吸水就可以了.  
2. 通常来讲,当瓶内的钢笔水较少时,一般会或多或少的存在些沉淀,因此这部分钢笔水不用也罢,免得造成钢笔水因粘稠而下水不畅的情况.

[拆下墨囊用注射器灌满墨水后装回去](https://www.reddit.com/r/fountainpens/comments/1by815i/is_there_a_reason_not_to_just_pull_the_converter/?tl=zh-hans)

注射器 针管 滴管 冷冻管

吸墨杯

派克 Quink 墨水瓶口内径 30 mm
