...
-   Once you have the lines selected, press the `SHIFT` + `I` keys to enter insert mode.
    -   ⇧ + <code>I</code> will allow you to insert text at the *beginning* of the highlighted lines.
    -   ⇧ + <code>a</code> will allow you to insert text at the *end* of the highlighted lines.
