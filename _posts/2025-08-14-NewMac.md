...
- Xcode Command Line Tools
  ...
  ```
- Terminal syntax highlighting for Zsh shell.
  
  - [Oh My Zsh](https://ohmyz.sh/#install)
    
    Oh My Zsh terminal will look like the following, and your VS Code terminal will also inherit the same style.
    ...
    Oh My Zsh plugin directory: `~/.oh-my-zsh/plugins/`.
