...
A: In the Preview Pane, right-click and choose `Show Preview Options`, then set the options you want.
...
4. In the First box, type `com.apple.metadata:kMDItemComment`. In the second box, type your comments. Click "Save". The Finder Comment will show in the Preview Pane.
...
- `Comments` add your file description here. It will work for Spotlight searches.
   ...
   Spotlight search can be evoked using gesture ["Four finger pinch"][four-finger] (pinching your thumb and three fingers together on the trackpad opens Launchpad) on the trackpad. So it can be distinguished from Alfred search (I remapped to ⌃+Space).
