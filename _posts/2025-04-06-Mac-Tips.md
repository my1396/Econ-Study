...
A: You can install the font in the Font Book app, restart Word, it will be available then.
...
> Some fonts can be downloaded automatically if needed. If you both have active Office 365 subscriptions and you use one of the fonts provided with it, you shouldn’t have to embed it. If you downloaded fonts from sites such as Google Fonts, including free-to-use ones, you’ll probably want to embed.
