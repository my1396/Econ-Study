...
2. Also need to upload the solutions to Canvas.
...
<span style='color:#32CD32'>**Tips**</span>:

- Save your edits frequently! No auto saving in Inspera.
...
<img src="https://drive.google.com/thumbnail?id=1riRy6NQogp2DMgs0s-S57ELH5IQi2_5d&sz=w1000" alt="Multiple Choice" style="display: block; margin-right: auto; margin-left: auto; zoom:80%;" />

- Create Tables in LatexiT, save to pdf then convert to png. Add table as png. 

  You can copy and paste tables from Microsoft Word to Inspera.
...
But when you need to insert latex formulas in <span style='color:#32CD32'>alternatives in multiple choice</span>, you can choose `LaTex` then type latex directly. Do not need to add dollar signs or any delimiters, type your equations directly.
...
Inspera Assessment supports writing LaTeX directly in the question text.

<https://support.inspera.com/hc/en-us/articles/360024281571-LaTeX-mode>
...
2. **Information:** This feature requires activation. Contact Inspera Service Desk to activate.



**Tables** can be copied and pasted from Microsoft Word.
...
Open response questions need to choose `Essay` type, so that it is possible to type equations.
