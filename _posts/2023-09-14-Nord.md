...
Travel Agency: SharePoint $\rightarrow$ **Berg-Hansen** 
...
Nord SharePoint $\rightarrow$ Snarveier $\rightarrow$ Inspera
...
After the exame date, need to upload the solution on Inspera so that sensors get access and can start grading.
