...
Renaming or moving files with `git mv` <u>preserves the file’s history</u> and is especially useful in collaborative development to maintain a clear and organized project structure.
