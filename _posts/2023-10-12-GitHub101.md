...
With `foo/*`, Git will process the direct contents of `foo`, giving other patterns a chance to re-include subdirectories like `foo/include_me/`. [↩](https://stackoverflow.com/a/5534865)
