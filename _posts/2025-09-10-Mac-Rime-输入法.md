...
- 用户配置文件目录 `/Users/<user-name>/Library/Rime/`
  ...
  ❗The repo is <span class="env-red">**private**</span> for security reasons because it contains sensitive user data. 
...
`color_schema: github` 必须存在于 `preset_color_schemas` 之中
