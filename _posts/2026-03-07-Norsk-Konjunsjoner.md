...
<span class="env-green">Comma is mandatory before conjunctions («og», «eller», «for», «men»).</span> 

- Jeg er glad i deg<span class="env-green">, og</span> jeg vet at du holder av meg.  
  → I love you, and I know that you care about me.
- De synes det er fint å være ute<span class="env-green">, men</span> de liker ikke å gå langt.  
  → They think it's nice to be outside, but they don't like to walk far.

However, a comma <span class="env-green">can be dropped if both sentences are very short.</span>
...
- Ungene var sultne, **så** han måtte lage middag.

- Han hadde feber, **så** han kunne ikke gå på jobb. 

- Jeg vil komme i form, **så** jeg må trene mer. 
