...
- Multiple classes can be applied to a single element in HTML. Then the classes can be either styled individually using `.class_1` and `.class_2` or that element could be styled only that contains both of the classes using `.class_1.class_2`.
