...
- «sub + ser + adj + ut»: adj 要与 sub 进行性数匹配，且用 indefinite form。

  |               | Example                         |
  | ------------- | ------------------------------- |
  | Fem singular  | Hun ser profesjon**ell** ut.    |
  | Neut singular | Det ser profesjon**elt** ut.    |
  | Plural        | De ser profesjon**elle** ut.    |
  
  Noen liker å se profesjon**elle** ut. → adj 修饰 plural noun "noen"，因此用 plural form "profesjonelle".
...
**No article in indefinite form**

英文中，名词非特指时，前面要加不定冠词 "a/an"。
但在挪威语中，有一种情况很特殊，会让习惯说英语的人觉得困扰: 非特指的名词前面不加冠词。
比如:

Han er lærer. → He is a teacher.

详细规则见 <a href="{{site.baseurl}}/2026/03/10/Norsk-No-Article.html">Norsk Grammar – No Article</a>.
...
<span class="env-green">**Ordinal numbers and «sist», «neste», «forrige», «følgende», and «samme»**</span>

这些词自带定冠词属性，因此可选择是否省略冠词 «den/det/de» 。

省略冠词的情况下，又分为 

(1) 名词冠词和形容词冠词都省略；(neither a determiner nor an end article)  
(2) 仅省略形容词冠词。

| 完全体               | 形容词和名词冠词都省略<br />(更常见)     | 仅省略形容词冠词    |
| ------------------- | ---------------------- | ------------------------------ |
...
> Tips: 
> - «samme + definite noun» 仅用于时间相关的表达 (day, week, month, year)。<span class="env-orange">不可用于其他事物。</span>
> - Use either the full form «den/det/de + samme + definite noun», or the reduced form «<span class="env-green">samme + indefinite noun</span>». 
...
| 完全体                              | 形容词和名词冠词都省略                   |
| ---------------------------------- | ------------------------------------ |
| **den** samme høye kvalitet**en**  | samme høye kvalitet                  |
| **den** samme bok**en**            | samme bok                            |
| **den** samme måt**en**            | samme måte                           |
| **den** første etasj**en**         | første etasje                        |
| **den** andre mulighet**en**       | andre mulighet                       |
| **det** neste russiske presidentvalg**et** | neste russiske presidentvalg |
| **det** følgende generelle råd**et** | følgende generelle råd             |

❗ For uncountable nouns (mass nouns), the only correct form is "samme + indefinite noun."

| Norsk                       | English                         |
| --------------------------- | ------------------------------- |
| samme oppdragelse           |  the same upbringing            |

Gutter og jenter bør få samme oppdragelse.  
→ Boys and girls should get the same upbringing.  

**Plural nouns:**

- "de samme + definite plural noun"
- "samme + indefinite plural noun"


| 完全体                       | 形容词和名词冠词都省略              |
| --------------------------- | ------------------------------- |
| de samme rettighetene       | samme rettigheter                 |

Alle mennesker bør ha **de samme rettighetene** uansett etnisitet og kjønn.  
Alle mennesker bør ha **samme rettigheter** uansett etnisitet og kjønn.  
→ All people should have the same rights regardless of ethnicity and gender.

Mange har ikke **de samme mulighetene** til å få en god utdanning.  
Mange har ikke **samme muligheter** til å få en god utdanning.  
→ Many do not have the same opportunities to get a good education.



--------------------------------------------------------------------------------

在 "<span class="env-green">the absolute superlative</span>" 中，一般也省略冠词 «den/det/de»，后面跟非特指名词 (indefinite noun)。


Q: What is "absolute superlative"?  
A: "Absolute superlative" is used to indicate the highest degree of a quality, without directly comparing it to anything else.

| Norsk                  | English                                               |
| ---------------------- | ----------------------------------------------------- |
| i beste fall           | at best; in the best case                             |
| i siste instans        | as the last resort; ultimately; in the final instance |
| på beste måte          | in the best way                                       |
| i høyeste grad         | to the greatest extent                                |
| i seneste laget        | a bit too late                                        |
| varmeste gratulasjoner | warmest congratulations                               |
| øvereste hylle         | top shelf                                             |
| nederste hylle         | bottom shelf                                          |
...
| Norsk                          | English                               |
| ------------------------------ | ------------------------------------- |
| å kvie seg for å gjøre noe     | to be reluctant to do something       |

- Han *kvier seg for å* snakke i offentligheten.  
...
- Han *kvier seg for å* be om penger.  
  → He is reluctant to ask for money.

| Norsk                          | English                               |
| ------------------------------ | ------------------------------------- |
| å unne seg noe                 | to allow oneself sth, indulge oneself |
...
- 只有 Min (我), Din (你), 和 Vår (我们) 有性数变化。

- Hans (他), hennes (她), deres (你们，他们) [以 «-s» 结尾的所有格] 没有性数变化。
...
\* The easiest way to know if you should use <span class="env-green">“sin, si, sitt, sine”</span> (reflective possessives, 她/他/它自己的，只有第三人称单数有反身代词) is ask yourself if “<span class="env-green">**own**</span>” can be inserted into the sentence in English and make sense.
...
1. 当主语和所有格指代同一人时，使用反身所有格，表示 "自己的"。
2. sin / si / sitt / sine 的性别和数要与名词保持一致，而不是与主语保持一致。

一个小 tips: 根据位置来判断是否应该用反身所有格。

- 主语: 你<span class="env-orange">永远不会在主语位置使用 "sin / si / sitt / sine".</span>
- 宾语: 
  - 当宾语指代主语时，使用 "sin / si / sitt / sine"; 
  - 当宾语不指代主语时，使用 regular possessive pronouns (hans, hennes, deres)。

💡 You do <span class="env-orange">NOT use "sin / si / sitt / sine" in the subject position</span>. They will always be used in the object position, referring back to the subject.
...
- [Norsksidene – Eiendomsord](https://norsksidene.no/web/PageND.aspx?id=99215)
...
Adjektiviske leddsetninger: brukes som adjektiv; de beskriver et substantiv og står etter det substantivet de beskriver. Substantivet heter «nominal ledd.»
...
- Hjemmeeksamen skaper en situasjon **der** studentene kan bruke alle hjelpemidler.
  → Home exams create a situation **where** students can use all resources.
- Det finnes yrker **der** det er viktig å kunne flere språk.  
  → There are professions **where** it is important to know several languages.
- De jobber i et system **der** alle må følge strenge regler.  
  → They work in a system **where** everyone has to follow strict rules.
- Vi ønsker et samfunn **der** alle har like rettigheter.  
  → We want a society **where** everyone has equal rights.

**Time:**

- Jeg husker et tidspunkt **der** alt endret seg.
  → I remember a time **when** everything changed.

- Det var en tid **der** det var vanskelig å få jobb.  
  → It was a time **when** it was difficult to get a job.

- Vi lever i en tid **der** teknologi utvikler seg raskt.
  → We live in a time **when** technology is developing rapidly.

**Place/location:**

- Dette er huset **der** jeg vokste opp.  
  → This is the house **where** I grew up.
- Vi fant en restaurant **der** maten var veldig god.  
  → We found a restaurant **where** the food was very good.
...
- Indirekte: 
  ...
  *Jeg vet ike **hvor** han har gått.* (I don't know where he has gone.)
...
- «å passe til noe(n)» = to suit, to match
  ...
  Det passer til situasjonen. → It suits the situation.

- «å passe for» can mean two things:
  
  1. to be **suitable for sth/sb** 
...
- «å passe på noe(n)» 
  ...
  2. to take care of sth/sb; to watch sth/sb
...
- Du må venne deg til den norske maten hvis du skal bo her. 
  → You have to get used to the Norwegian food if you are going to live here.
...
2.  **være enig <span class="env-green">i noe</span>** → agree in sth
    ...
    → I agree that it is important to learn languages.
...
多 mye – <span class="env-green">mer</span> – mest  
少 liten – <span class="env-green">mindre</span> – minst
...
1. 后缀比较级: 在 adj. 后缀 "-ere" (superlative 用 "-est"), 然后用 «enn» 引导比较对象。
   ...
   Vi tjerner 20% mindre **enn** våre kolleger.  
  → We earn 20% less than our colleagues.
...
«Enda» (even more) 和 «mye» (much more) 都可以用来加强比较级，表示程度更高。

- Jeg er *enda* mer interessert i norsk nå.  
  → I am even more interested in Norwegian now.
...
- Jeg blir *<u>mer</u> interessert* i norsk jo bedre jeg forstår det.  
  → I become more interested in Norwegian the better I understand it.
- Hun er *<u>mer</u> interessert* i økonomi enn i markedsføring.  
  → She is more interested in economics than in marketing.
- Studentene ble *<u>mer</u> interessert* etter at læreren forklarte temaet på en enklere måte.  
  → The students became more interested after the teacher explained the topic in an easier way.
- Han virker *<u>mer</u> forberedt* til eksamen nå.  
...
- Filmen var bra, men boka var *<u>mer</u> spennende*.  
  → The movie was good, but the book was more exciting.
- Jeg synes den andre delen av serien er *<u>mer</u> spennende* enn den første.  
  → I think the second part of the series is more exciting than the first.
- Det er alltid *<u>mer</u> spennende* å reise til et nytt sted.  
  → It is always more exciting to travel to a new place.
- Historien ble *<u>mer</u> spennende* etter hvert kapittel.  
...
ulik/ulikt/ulike → different, unlike [used to express dissimilarity]

Bergen er *ulik* andre norske storbyer.  
→ Bergen is unlike other large Norwegian cities.

100 personer av *ulikt* etnisk opphav, kjønn og alder  
→ 100 people of different ethnic origin, gender, and age
...
Hun er *like stor* som broren sin.  
→ She is as big as her brother.

Piggfritt er *like godt* som piggdekk.  
→ Tires without studs are as good as studded tires.

--------------------------------------------------------------------------------

**lik, ligne**

- lik/likt/like → adj. alike, similar to
