...
Check user manual: Do-it-yourself maintenance -- Tires pp. 543

更换轮胎后需要进行压力初始化。

轮胎压力警告灯可能由于自然原因(如自然漏气和温度引起的轮胎气压变化)而点亮。在此情况下，调节轮胎气压可熄灭警告灯(数分钟后)。

<a id="tire-pressure"></a>
...
5. 按下 &and; 或者 &or; 选择 “车辆设定” (Vehicle Settings)，按下 OK

6. 按下 &and; 或者 &or; 选择 “TPWS”，按下 OK

7. 按下 &and; 或者 &or; 选择 “设置轮胎气压” (Set Pressure)，按下 OK 直至<span class="env-green">轮胎压力警告灯闪烁3次</span>。
   
   <img src="{{site.baseurl}}/images/TPWS tire pressure.png" alt="" style="display: block; margin-right: auto; margin-left: auto; zoom:80%;" />

8. 以约 40 km/h 或更高速度直线行驶 (偶尔左右转向)约 10至30分钟。

   各轮胎位置确定且多信息显示屏上显示各轮胎气压时，初始化完成。
   在某些情形下(如车辆等红绿灯而长时间停车时)，初始化时间可能超过约1小时。

<a id="tire-rotation"></a>
...
为确保轮胎磨损均匀并延长其使用寿命，丰田公司建议每行驶约 <span class="env-green">10,000 km 进行一次轮胎换位</span>。
...
汽车后视镜除油膜完整方案 (区分: 轻度 / 顽固硅质油膜)

先分清你的情况

1. 轻度油膜：只是灰尘、虫胶、浮油污 → 你手里这瓶[氨水玻璃清洁剂](https://www.biltema.no/bilpleie/utvendig-bilpleie/glassrens-og-glassforsegling/glassrengjoringsskum-400-ml-2000045560)就能日常维护

2. 顽固油膜 (典型硅油膜)：淋水后水珠成片、雨天发雾、擦完很快复发 → 单纯玻璃水/清洁剂无法根除，必须研磨

方案一：轻度油膜（日常保养）

材料：你手上这款玻璃清洁剂 + 超细纤维毛巾（分两块：擦拭/收水）
步骤：
...
4. 清水湿毛巾擦一遍带走残留
5. 干毛巾彻底擦干，避免水印  
   ⚠️ 不要让液体长时间浸泡后视镜橡胶外壳、塑料底座（氨水会加速老化）

方案二：顽固油膜（最推荐，根治）

材料选择（二选一）

A. 成品油膜去除膏（含二氧化硅研磨粒子）【新手首选】
B. 洗车黏土/美容黏土 + 润滑液
❌ 不要用牙膏！颗粒粗细不均，容易划伤后视镜镀膜/玻璃
标准操作步骤

1. 清水冲洗后视镜，冲掉沙尘（防止干磨刮花玻璃！重点）
2. 镜面保持湿润，挤少量除油膜膏在湿海绵/专用擦片上
3. 小范围画圈匀速打磨，整面打磨1～2分钟，能明显感觉到摩擦力变滑（油膜被磨掉）
4. 清水冲净泡沫，立刻观察：淋水，水珠均匀铺展、不聚团=油膜清除
5. 清水冲洗干净，超细纤维毛巾擦干

进阶长效防护（可选）

除干净油膜之后，可以涂后视镜驱水镀膜/防雨剂
作用：雨水不容易附着，减少再次形成油膜速度；一般维持1～3个月

⚠️ 关键避坑

1. 禁止干磨！表面有沙子直接研磨=永久细微划痕
2. 后视镜很多带有防眩光蓝色镀膜：研磨力度不要过大，不要频繁重度打磨，过度打磨会损伤镀膜
3. 你这款含氨水清洁剂：只做日常清洁，不要拿来长时间浸泡、反复重度处理
4. 不要在烈日下施工，液体快速风干极易留下印记

快速判断有没有清干净

清水泼后视镜：  
✅ 水形成完整水膜均匀铺开 → 油膜去除成功  
❌ 水珠一颗颗抱团、局部疏水 → 还有残留油膜，继续打磨
