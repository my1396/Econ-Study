...
- The standard TeX distribution is called <span class="env-green">**TeX Live**</span>. ✅
  ...
  [TeX Live](https://www.tug.org/texlive/) is a *free* comprehensive TeX system that includes all the major TeX-related engines (TeX, pdfLaTeX, XeTeX, and LuaTeX), macro packages (`amsmath`, `booktabs`, etc. common packages used for formating your manuscript), and fonts.
...
- MacTeX is a large download, about 6 GB. 
...
- Installation takes about *eight to ten minutes* on recent computer models.
