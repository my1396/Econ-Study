...
If need to check data item definition, use the [FactSet Marketplace Catalog](https://www.factset.com/marketplace/catalog) → FactSet Fundamentals → RESOURCES → Documentation → Data Dictionary or Data Methodology: <https://www.factset.com/marketplace/catalog/product/factset-fundamentals>
