...
| fref_security_type                               | Code denoting the security's type, see [page 15776 OA](https://my.apps.factset.com/oa/pages/15776) for a list of security type descriptions. |
...
| `fsym_regional_id`                               | Regional-level FactSet Permanent Identifier associated with the  identifier |
