...
- Old portal: <https://open.factset.com/navigator/>
- New portal (with Copilot AI chat): <https://datanavigator.factset.com>
...
If need to check data item definition, use the [FactSet Marketplace Catalog](https://www.factset.com/marketplace/catalog) → FactSet Fundamentals → RESOURCES → Documentation → Data Dictionary (overview of all fields covered) or Data Items Definitions (formula for the term): <https://www.factset.com/marketplace/catalog/product/factset-fundamentals>
...
- But actually can ONLY be queried by <span style='color:#00CC66'>regional level `fsym_id`</span>. ✅
...
Quadrants based on Material and Immaterial categories {% cite Khan2016 %}
