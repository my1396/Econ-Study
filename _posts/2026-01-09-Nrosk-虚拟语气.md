...
> With «om» clause:  
> must use <span style="color: #00CC66;">past tense</span>
...
Modal verb: kunne (could), ville (would), burde (should), måtte (must)
...
> - 注意 «burde» 是过去式  
> obligation or regret in the past 
...
Hvis jeg want en million, ville jeg dra på jordomseiling.  
...
Hvis jeg want en million, skulle jeg dra på jordomseiling.  
