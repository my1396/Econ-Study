...
- <span class="env-green">Assignment Quizzes</span>: show in grade book, can be graded, and students can see their results
  - [**Speed Grader**](#Speed-Grader) is enabled; can give feedback to individual students through submission comments; students can also send messages;

- Practice Quizzes
  - Not graded, not shown in grade book.
...
1. Don't forget to **shuffle answers**. Otherwise, for multiple choice questions, the correct answer always show as the first choice.
...
<span class="env-green">But it won't keep the order of questions</span> when you import questions from an Item Bank into a quiz. 
