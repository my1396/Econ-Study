...
layout: post
tag: Norsk
title: "Norsk Grammar – Setningsadverb"
update: 2026-01-13
---
...
A: Setningsadverbial (句子状语) 是一个更广泛的概念, 包括 setningsadverb (句子副词) 以及其他类型的句子成分（如副词短语、介词短语，也可以是从句）用来修饰整个句子。包含关系: setningsadverb ⊂ setningsadverbial.
...
- «Også» kan stå til subjekt, men <span class="env-orange">det er ikke så vanlig</span> i muntlig språk.
