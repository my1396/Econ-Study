...
|                                                 | [DS223J](https://www.synology.com/en-eu/support/download/DS223j?version=7.2#docs) | [D223](https://www.synology.com/en-eu/support/download/DS223?version=7.2#docs) |
| ----------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| <span style='color:#00CC66'>**硬件规格**</span> |                                                              |                                                              |
| CPU 处理器                                      | Realtek RTD1619B                                             | Realtek RTD1619B                                             |
| 内存                                            | 1 GB DDR4                                                    | 2 GB DDR4                                                    |
| 硬盘类型                                        | 2 x 3.5" SATA HDD                                            |                                                              |
| 热插拔硬盘<br />(Hot Swap)                      | 否                                                           | 是                                                           |
| 单个硬盘的最大容量                              | 16 TB                                                        | 16 TB                                                        |
| 外接端口                                        | 2 x USB 3.2 Gen 1 端口                                       | 3 x USB 3.2 第 1 代端口                                      |
| 网络 LAN 端口                                   | 1 x 1GbE RJ-45                                               | 1 x 1GbE RJ-45                                               |
| 软件 DSM 产品规格                               |                                                              |                                                              |
...
`zh-cn` 简体中文 <https://kb.synology.cn/zh-cn>
