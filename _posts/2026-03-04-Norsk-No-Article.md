...
This post summarizes the main rules for when to use no article in Norwegian.
...
1. the noun is modified by an adjective:

   Han er en **dyktig** lærer.  
   → He is a **skilled** teacher.

2. the noun is qualified by a restrictive relative clause:

   Han er **en lærer som** kan sine ting.  
   → He is a teacher who knows his stuff.

3. the noun is of a more subjective nature
