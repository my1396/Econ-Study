...
- `_layouts` Files in the `_layouts/` directory can be used as page **templates**. 模板

  All the repeating code on our site like the header, footer and navigation are typically in a layout.

  - `base.html`
  - `home.html`     homepage typesetting, 主页
  - `page.html`
  - `post.html`
...
[**Rouge**](https://github.com/jneen/rouge) is a pure-ruby syntax highlighter and has been the default highlighter for Jekyll since Jekyll 3 (replacing pygments). 
