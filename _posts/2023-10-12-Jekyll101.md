...
Jekyll converts markdown files to html; helps to generate blogs in a minimalistic style.
...
Run `source ~/.bash_profile` every time you make changes with the file. [✘]
