...
> Note that must install ruby 3.x. Higher versions such as 4.x have compatability issues with GitHub Pages.  
...
It takes some time (10 to 15 mins) to install ruby. Extra slow on an older Mac with slow internet connection.

--------------------------------------------------------------------------------

Here is my installation steps using `ruby-install` and `chruby` on macOS:
