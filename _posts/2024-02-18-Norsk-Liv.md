...
**å bli satt ut** → be shocked / stunned
...
<span class="env-green">-ende form</span> 现在分词形式 (presens partisipp)，可以作形容词用，表示 «…的»，强调<span class="env-green">主动性</span>。没有性数字变化。
...
**«om-»** → around, about, concerning; re- (repetition, doing again)
...
**«be-»** → makes the verb transitive or more formal.
