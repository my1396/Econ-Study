...
- 超过是 <span class="env-green">over</span>; 快到是 <span class="env-green">på</span>.
- 15分钟为界限，跟整点和半点做比较。
...
<span class="env-green">«i kveld» vs. «om kvelden»</span>
...
- om kveld<span class="env-green">en</span>: in the evening; generally during the evening, in general

  Det er stille *om kvelden*.  
  → It is quiet in the evening.

  Vi skal ikke bli dit før *om kvelden*.
  → We will not be there until the evening.

--------------------------------------------------------------------------------

<span class="env-green">«i natt» vs. «om natta»</span>

- **i natt:** tonight, last night; a specific night, usually the most recent one or the coming one 昨晚
...
- **om natta:** at night; generally during the night, in general 泛指晚上
  
  Jeg jobber best om natta.  
  → I work best at night.

  Det er stille om natta.  
  → It is quiet at night.

  Katter er aktive om natta.  
...
| iblant (also as «i blant»), av og til, til tider, nå og da | sometimes 有时… |
...
- Vi skal være ut i løpet av mesten av dagen.  
  → We will be out for most of the day.

| Norsk                    | English                 |
| ------------------------ | ----------------------- |
| fram til + tidspunkt     | until a specific time   |

- Butikken er åpen fram til klokka 18.  
  → The store is open until 6 PM.
- Jeg jobbet fram til fredag.  
  → I worked until Friday.
...
- *Hun har ventet på tre timer.* or *Hun har ventet <span class="env-green">i</span> tre timer.* (The latter is more common.)  
...
<table>
    <tr>
      <td><span class="env-green"><em>i</em></span> vinter/sommer</td>
        <td><span class="env-green">this</span> winter/summer</td>
    </tr>
    <tr>
...
Always use <span class="env-green">i</span>:
...
|             | I påska er vi hjemme.              |
| Fortid      |                                    |
|             | Vi hadde det fint i jula.          |
|             | Vi dro til Roma i påska.           |
| Fremtid     |                                    |
|             | Kommer du hjem i jula / til jul?   |
...
If it's a specific day, we use "på":

på julaften / første juledag / palmensøndag
...
| ------------- | ---------------------------- | ------------ |
| <span class="env-green">**et antall**</span> | countable items | number of    |
| **en mengde** | uncountable mass             | amount of    |
| **<span class="env-green">et beløp</span>**  | money           | sum / amount |
| **en sum**    | total quantity (often money) | total / sum  |


Det er bare en begrenset <span class="env-green">antall</span> plasser tilgjengelig.   
→ There is only a limited number of seats available.

Jeg visste ikke at det var så stort <span class="env-green">antall</span> mennesker som kom til festen.  
...
*Antall* biler på parkeringsplassen øker.  
→ The number of cars in the parking lot is increasing.

*Antall* feil i teksten var lavt.  
→ The number of errors in the text was low.

英语和挪威语表达数量的主要区别:

- 英语要加介词 of 并且加定冠词 the: the number of people
- 挪威语直接加名词 用非特指: antall mennesker/elever
  
  特指/非特指: 无严格区分，if you see definite form, it is usually in formal writing.
  In spoken language, indefinite form is fine.

**en mengde, mengden, mengder, mengdene**

Å huske handler også om å redusere *mengden* ting du må huske.  
→ Remembering also involves reducing the amount of things you have to remember.

*Mengde* snø i Nord-Norge kan variere mye.  
→ The amount of snow in Northern Norway can vary a lot.

Vi må redusere *mengden* sukker i kostholdet.  
...
| et <span class="env-green">lite</span> / stor<span class="env-green">g</span> beløp | a small / large amount |
| et bestem*t* beløp                       | a certain amount                   |
| et maksimal*t* beløp                     | a maximum amount                   |
| et minimal*t* beløp                      | a minimum amount                   |
...
<span class="env-green">«Å komme på + number»</span> = to come to (the total amount)

### Greater / Less than

Greater than: <span class="env-green">mer enn / større en / over / drøyt</span>

Less than: <span class="env-green">mindre enn / lavere enn / under</span>
...
**drøyt** + number → just over …, a bit more than …

*drøyt* 100 kroner → just over 100 kroner

for *drøyt* et år siden → just over a year ago, a little over a year ago

--------------------------------------------------------------------------------

en majoritet, et flertall → majority
...
同英文中分数的表达方式: 基数 (cardinal) + 序数复数形式 (ordinal plural)

| Norsk           | English       | Fraction    |
| --------------- | ------------- | ----------- |
| en halv         | one half      | 1/2         |
| en tredjedel    | one third     | 1/3         |
| en fjerdedel    | one fourth    | 1/4         |
| to tredeler     | two thirds    | 2/3         |
| tre fjerdedeler | three fourths | 3/4         |
| fire femdeler   | four fifths   | 4/5         |
...
| en mør biff     | a tender steak          |
| kjøttet er mørt | the meat is tender      |
...
| Hvordan var ferien i Italia? Hvordan var det i Italia? | How was the holiday in Italy? How was it in Italy? |
...
| Kan du gjenta <span class="env-green">det</span> du sa? | Could you repeat what you just said? |
| ta hensyn til noen / andre           | show consideration for sb / others     |
| ta hensyn til noe                    | take something into consideration      |
...
| Kan jeg hjelpe deg? 店员询问是否需要帮助 | Nei, takk. Jeg vil bare kikke litt. / Jeg skal bare se litt. / Jeg ser bare. / Jeg vil bare ta en titt. / Jeg ser meg rundt. |

titt / kikk → look, peek, glimpse

å kikke → to look, peek, glance

å se seg rundt → to look around
...
| Er det utsolgt?                      | Is it sold out?                        |
| Når kommer varen tilbake på lager?   | When will the item be back in stock?   |
| Kan jeg få en kvittering?            | Can I get a receipt?                   |
| Skal vi ta en kopp kaffe?            | Shall we go having a cup of coffee?    |
| Vi du ta en kaffe på en kafé?        | Do you want to have a coffee at a café? |
| Vil du ha noe å drikke? / Vil du ha noe å spise? | Do you want something to drink? / eat? |
| … år gammel                        | … years old                          |
...
| Jeg regner med at de kanskje <span class="env-green">tar for mye</span>. | I guess they might be overcharging me. |
...
Other ways to say "it is ok": Den er grei. / Alt i orden. / Det ordner seg. / Det fikser vi. / Ikke no(e) stress. / OK (okå)
...
| Stemmer det at …?                     | Is it correct that …?                      |
| Det stemmer ikke. Tallene stemmer ikke. | It is not correct. The numbers don’t add up. |
...
| å prøve å gjøre noe                  | to try to do sth                       |
| å forsøke (å) gjøre noe              | to attempt to do sth                   |
...
| å rydde rommet                       | to tidy up the room                    |
| Huset er ryddig og rent.             | The house is tidy and clean.           |
...
| jeg skal sørge for at <span class="env-green">det blir gjort</span> | I will see to it. / I’ll take care of it. |
...
| å <span class="env-green">slite med</span> å gjøre noe | to struggle with doing sth; have difficulties with sth |
...
| Jeg <span class="env-green">**foretrekker**</span> kaffe **fremfor** te. | I prefer coffee to tea. |
...
| All den jobben var bortkastet.       | All that work was wasted.              |
...
| på kort sikt                         | in the short run                       |
| på sikt                              | over time, eventually                  |
| over natta                           | overnight, meaning sth happens fast    |
| i det sist<span class="env-green">e</span> | lately, recently                 |
| den siste tiden                      | recently                               |
| nå for tiden                         | nowadays                               |
| for tiden                            | currently                              |
| Det er på tide å gjøre noe.          | It is time to do something             |
| i rett tid                           | in time, just in time                  |
| i tide                               | in time                                |

- Det er *på tide* å ta sikkerhet på alvor.  
  → It is time to take safety seriously.
- Buseen kom *i rett tid*.  
  → The bus came in time.
- Alle skulle kunne få medisinsk hjelp av høy kvalitet *i rett tid*, uten for lang ventetid.
  → Everyone should be able to get high-quality medical help in time, without too long waiting time.

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| i god tid                            | in good time, well in advance          |
| å sløse bort tid                     | to waste time                          |
| å få tiden til å gå | to kill time; do sth so that free time feels shorter or less boring |
| å ha tid til overs                   | to have time to spare                  |
| å ha til til å gjøre noe             | to have time to do something           |
| på samme tid                         | at the same time                       |
| med tiden                            | with time, eventually                  |

- *Når for tiden* et det dyrt å bygge.  
  → Nowadays it is expensive to build.
- Jeg bor i Bodø *for tiden*.  
  → I am living in Bodø currently.
- Det er *på tide* å gjøre noe med det.  
  → It is time to do something about it.
- Det er *på tide* at vi drar.  
  → It is time for us to go.
- Jeg leser å *få tide å* gå.  
  → I read to pass the time.

More expressions with time: <a href="{{site.baseurl}}/2024/02/18/Norsk-Struktur.html#time-expression">HERE</a>

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| Har du tid til overs?                | Do you have time to spare?             |
| Har du tid <span class="env-green">til</span> å hjelpe meg litt? | Do you have time to help me a little? |
...
| Hva anbefaller du?                   | Do you have any suggestions?           |
| <span class="env-green">Kan jeg få regningen?</span> | Can I get the bill?    |
| Må prøves, men ikke likes.           | Must be tried, but not liked.          |
...
| Det <span class="env-green">banker</span> på døren. | Someone is knocking on the door. |
...
| <span class="env-green">noe er høyt verdsatt</span> | sth is highly valued                   |
...
| <span class="env-green">være i gang</span> med å gjøre noe | in the process of … |
| å <span class="env-green">komme i gang</span> med noe | to get started with sth  |
| å brette opp ermene                  | to roll up one’s sleeves 撸起袖子(准备大干一场) |
...
| Har du lagt merke <span class="env-green">til</span> … ? | Have you noticed … |
...
Hun legger merke til små detaljer.  
→ She notices small details.

Har du lagt merke til endringen?  
...
| <span class="env-green">låse seg inn</span>  | lock oneself in                |
| for eksempel                         | for example                            |
| Beklager at jeg <span class="env-green">forstyrret</span> deg. | Sorry for interrupting you. |
...
<span class="env-green">**与雪相关**</span> ❄️

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| å <span class="env-green">måke</span> snø | to shovel snow                    |
| en snøskuffe                         | a snow shovel 雪铲                      |
| å <span class="env-green">brøyte</span> snø | to clear snow (with a machine)  |
| brøytebil                            | snow plough lorry 铲雪车                |
| snøen <span class="env-green">smeltet</span> | the snow melted                |
| å strø veiene                        | to grit the roads                      |
| strøbil                              | gritting lorry 洒石子的车                |
| å strø sand på veiene                | to grit the roads with sand            |
...
| glatt                                | slippery                               |
| å havne i <span class="env-green">grøfta</span> | to end up in the ditch      |
...
1. verb. to shovel (snow)
   
   fjerne snø ved å bruke en måke (shovel) 铲雪
2. noun. en måke → a shovel
3. noun. en måke → a seagull

<span class="env-green">Veien ble brøytet</span> etter snøfallet → The road was cleared after the snowfall

Folk må <span class="env-green">måke snø på innkjørselen</span> hver dag. → People have to shovel snow on the driveway every day.

Det kunne ta tid før alle veiene er <span class="env-green">rydda/ryddet</span>. → It could take time before all roads are cleared.

Veiene <span class="env-green">blir ofte brøytet raskt</span> etter snøfall i Norge. → The roads are often cleared quickly after snowfall in Norway.
...
<span class="env-green">**接受现状，顺其自然**</span>
...
| Jeg stikker innom deg senere.        | I will stop by you later.              |
| Jeg stikker innom butikken på vei hjem. | I will stop by the store on the way home. |
| Jeg stikker innom kontoret ditt senere. | I will stop by your office later.     |
...
| være basert på noe, på grunn av noe  | be based on sth                        |
...
| Det er <span class="env-green">rørende</span>. | It is touching.      |
...
| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| Jeg ble helt <span class="env-green">blankt i hodet</span>. | My mind went completely blank. |
...
| <span class="env-green">å gi gass</span> | to give gas (slang), accelerate, speed up |
| å bremse                             | to brake                               |
...
| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| å <span class="env-green">klappe</span> noen på skulderen | to pat sb on the shoulder |
| å klappe hunden på hodet             | to pat the dog on the head             |
| Kan jeg klappe hunden din?           | Can I pet your dog?                    |
| Hunden er i <span class="env-green">løpetid</span>. | The dog is in heat. (meaning be able to be pregnant) |
...
| å avlyse/kansellere en flyvning      | to cancel a flight                     |
| å innstille toget                    | to cancel the train                    |
| være avlyst/kansellert/innstilt      | to be cancelled                        |

«Innstille» is used generally for public transportation, e.g., tog, buss, ferge, flyvning, etc.

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| være forsinket                       | to be delayed                          |
| å være i rute                        | to be on schedule                      |



--------------------------------------------------------------------------------

<span class="env-green">**Effort**</span>

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| Det tar <span class="env-green">tid og krefter</span>. | It takes time and effort. |
...
> 
> "Krefter" is used as a (uncountable) mass noun, so we say "<span class="env-green">mye krefter</span>" (a lot of effort) rather than "<s>mange krefter</s>" (many efforts).
>
> 区别于形近词 «kreft» which means "cancer".
...
| <span class="env-green">medbrakt</span> | brought-in (your own)       |
...
| å lage en <span class="env-green">summelyd</span> | to make a humming sound / buzzing noise |
...
- Folk *tar/henter/plukker <u>fram</u>* juletreet før jul.
- Folk *tar <u>opp</u>* juletreet før jul.


When Christmas is over, people **put away** their Christmas trees.

- Når julen er over, må folk *rydde <u>bort</u>* juletreet.
- Etter at julen er over, *legger* folk *<u>bort</u>* juletreet.
- Etter at julen er over, *legger* folk *<u>bort</u>* juletreet.
...
- Prisene på boligmarkedet har skutt i været det siste året.
  → Housing prices have soared over the past year.
...
| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| Jeg ønsker <span class="env-green">det beste</span> for deg.  | I wish the best for you. |
| Jeg ønsker deg lykke til.            | I wish you good luck.                  |
| Lykke til med …                    | Good luck with …                     |

uflaks(en) → bad luck, misfortune

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| grunnleggende funksjoner             | basic functions                        |
| å fungere som forventet              | to function as expected                |
| å fungere <span class="env-green">smidig</span> | to function smoothly        |
| være egnet for noe                   | be suited / suitale for sth            |
| være egnet til å gjøre noe           | be suited / suitable to do sth         |

- Hun er godt *egnet for* jobben.  
  → She is well *suited for* the job.

- Han er *ikke egnet til å* jobbe under høyt press.  
  → He is not suited to working under high pressure.

- Denne bilen er *egnet for* lange turer.  
  → This car is *suitable for* long trips.

- Denne stillingen er *særlig egnet for* personer med teknisk bakgrunn.  
  → This position is *particularly suited for* people with a technical background.

| norsk                               | English                                |
| ----------------------------------- | -------------------------------------- |
| å komme / gå (godt) overens <span class="env-green">med noen</span>  | to get along (well) with someone |
| å komme/være overens <span class="env-green">om noe</span> | to agree on sth |
| å stikke av                         | to run away, to escape                 |

**å stikke, stikker, stakk, har stukket**

- Han *stakk av* fra politiet.  
  → He ran away from the police.
- Hun *stakk av* hjemmefra som tenåring.  
  → She ran away from home as a teenager.
- Tyven *stakk av* med pengene.  
  → The thief ran away with the money.
- Det vil gjøre ting verre for meg hvis jeg prøver å *stikke av*.  
  → It will make things worse for me if I try to run away.
...
- Vi kan gå en liten tur *på området*.  
  → We can take a little walk around the area.

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| Det er fullt forståelig.             | It is completely understandable.       |
| i min slekt og omgangskrets          | in my family and social circle         |
| Sett deg ned.                        | Please have a seat.                    |
| å gjøre opp for noe(n)               | to make up for sth/sb                  |

- Jeg håper jeg kan *gjøre opp* for meg i forhold til foreldrene mine.  
  → I hope I can make up for my parents.

- Jeg håper jeg kan *gjøre opp* for mine feil.  
  → I hope I can make up for my mistakes.

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| i voksen alder                       | i adulthood, as an adult               |
| i yngre alder                        | at a younger age                       |

*I voksen alder* utdannet jeg meg til sykepleier. Det er en utfordring å studere *i voksen alder*. Jeg synes jeg lærte raskere *i yngre alder*.  
→ I trained to be a nurse in adulthood. It is a challenge to study in adulthood. I think I learned faster at a younger age.

| Norsk                               | English                                |
| ----------------------------------- | -------------------------------------- |
| et par                              | a couple of; a pair of (two)           |
| være en <span class="env-green">prøvelse</span> for sine omgivelser | be a pain in the neck, be a pain in the ass |

en prøvelse, prøvelsen, prøvelser, prøvelsene → a trial

| Norsk                               | English                                |
| ----------------------------------- | -------------------------------------- |
| å skaffe til veie                   | å obtain / provide upon request        |

Referanser vil jeg skaffe til veie ved behov.  
→ I will provide references if needed.

关于可能性的表达 <a href="{{site.baseurl}}/2024/02/18/Norsk-Grammar.html#sammenligne">↩</a>

| Norsk                               | English                                |
| ----------------------------------- | -------------------------------------- |
| Det er større sjanse for at …     | There is a greater chance that …. <br/> It is more likely that … |
| Det er mindre sjanse for  at …    | There is a smaller chance that … <br/> It is less likely that … |
| Det er liten sjanse for at …      | There is little chance that … |

You can use «sannsynlighet» in stead of «sjanse» here.

注意 «sjanse» here is used as uncount. n., meaning "probability, likelihood." 某事发生的可能性。

| Norsk                               | English                                |
| ----------------------------------- | -------------------------------------- |
| Tid<span class="env-green">en</span> går fort.| Time flies.                  |

Note that in Norweigan, we use definite form "tiden", which is different from English "time". 

机场相关

| Norsk                               | English                                |
| ----------------------------------- | -------------------------------------- |
| Det er lang kø ved skranken.        | There is a long queue at the counter.  |

«Skranke» refers to a <span class="env-green">counter</span>, a desk, a bar, a reception desk, etc. It is a general term for a surface that serves as a barrier or divider between two areas, often used in contexts like customer service, offices, or bars.

«Kasse» refers to a cash register or checkout counter at a store.

Jeg må gå til innsjekkingsskranken for å sjekke inn.  
→ I have to go to the check-in counter to check in.

Hvor er Lufthansa sin innsjekkingsskranke?  
→ Where is the Lufthansa check-in counter?

sikkerhetskontroll → security control

Kan du skrive ut bagasje<span class="env-green">lappen</span> for meg?  
→ Can you print out the baggage tag for me?


| Norsk                               | English                                |
| ----------------------------------- | -------------------------------------- |
| å ta en titt på noe(n)              | to take a look at sth/sb               |

- Kan du *ta en titt* på denne rapporten?  
  → Can you take a look at this report?
- *Ta en titt* på nettsiden vår for mer informasjon.  
  → Take a look at our website for more information.
- Jeg skal *ta en titt* på det og komme tilbake til deg.  
  → I will take a look at it and get back to you.


| Norsk                               | English                                |
| ----------------------------------- | -------------------------------------- |
| Tenkte å høre om …                | I wanted to ask about …              |

«Tenkte å høre om du kunne hjelpe meg med …» is a common way to ask for help in Norwegian. It is a polite and indirect way to ask for assistance, similar to saying "I was wondering if you could help me with …" in English.

- Tenkte å høre om jeg kan sove hos deg.
  → I was wondering if I can sleep at your place.

**å lure på noe** → to wonder about sth, to be curious about sth

- Jeg lurer på om du kan hjelpe meg med dette.  
  → I wonder if you can help me with this.

| Norsk                               | English                                |
| ----------------------------------- | -------------------------------------- |
| å ha forbedringspotensial           | to have room for improvement           |
| å bety ikke nødvendigvis at …     | to not necessarily mean that …       |

«ikke nødvendigvis» → no necessarily (as a softener in a statement)

Det er *ikke nødvendigvis* sant. → It is not necessarily true.

| Norsk                               | English                                |
| ----------------------------------- | -------------------------------------- |
| Jeg har planer.                     | I have plans.                          |
| Det gjenstår å se.                  | It remains to be seen.                 |
| det er for mye forlangt at …      | It is too much to ask that …         |
| Det var flaut.                      | It was embarrassing.                   |
| å ta på alvor                       | to take it seriously                      |

- Du må ta dette på alvor.  
  → You have to take this seriously.
- Hun tok problemet på alvor.  
  → She took the problem seriously.

| Norsk                               | English                                |
| ----------------------------------- | -------------------------------------- |
| å lide av noe(n)                    | to suffer from sth/sb                  |
| å lide under noe(n)                 | to suffer under sth/sb                 |
| Dette traff meg rett i hjertet.     | This hit me right in the heart.        |
| alt annet som behandler om noe      | everything else that is about sth      |
| i deres egen øyne                   | in their own eyes                      |
| personlige interesser               | personal interests                     |
| å bestemme sin egen fremtid         | to determine one’s own future          |
| Det er noe vi ikke må ta for gitt.  | It is something we must not take for granted. |
| Det er mye som blitt gjort for å få til alt dette. | There is a lot that has been done to make all this happen. |
| Har noe lignende skjedd før? / Har dette skjedd før? / Har en slik situasjon/hendelse skjedd før? | Has something similar happened before? |
| stor forskjell mellom by og land, og fra landsdel til landsdel. | big difference between city and countryside, and from region to region. |
| noe spiller inn                      | sth plays a role, sth is a factor     |
| på godt og vondt                     | for better or worse                   |
| for turens egen skyld                | for the sake of the trip itself       |

<span class="env-green">for … egen skyld</span> → for the sake of … itself

- Jeg gjør det *for din skyld*.  
  → I’m doing it for your sake.

- Ikke bekymre deg *for min skyld*.  
  → Don’t worry on my account.

- Jeg tok med ekstra nøkler *for sikkerhets skyld*.
  → I brought extra keys just in case.

- Vi gjorde det bare *for moro skyld*.  
  → We did it just for fun.

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| … er vant til å få det som man vil | is used to having things the way one wants |
| Det er fullstendig uakseptabelt.     | It is completely unacceptable.         |
| å seire over noe(n)                  | to triumph over sth/sb                 |
...
| Norsk                                 | English                                |
| ------------------------------------- | -------------------------------------- |
| Jeg makter det ikke.                  | I can't do it. I'm not up to it.       |
| Det skal ikke så mye til å gjøre noe. | It doesn't take much to do sth.        |
| Det gir jeg blaffen.                  | I couldn't care less.                  |
| Jeg har blitt fortalt at …            | I've been told that …                  |
| å behøve ikke bety at …               | … does not necessarily mean that …   |

- Å være stille behøver ikke bety at man er enig.  
  → Being quiet does not necessarily mean that someone agrees.
- Høye priser behøver ikke bety høy kvalitet.  
  → High prices do not necessarily mean high quality.
- Å gjøre feil behøver ikke bety at du er dårlig.  
  → Making mistakes does not necessarily mean that you are bad.

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| Det går over etter en stund.         | It will pass after a while.            |
| Smerten gikk over.                   | The pain went away.                    |
| Forkjølelsen går over snart.         | The cold will go away soon.            |

en stund → a while, a moment, a bit of time (a moderate amount of time. Not extremely short, but not very long either.)

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| Noe(n) er gull verdt.                | sth/sb is invaluable.                  |
| høyt forbruk av ferdigprodusert mat  | high consumption of processed food     |
| uten at vi alltid er klare over det  | without us always being aware of it    |
| å å motstå fristelser                | to resist temptations                  |
| Vi må bare slutte å tenke på kortsiktige løsninger som … | We just have to stop thinking about short-term solutions like … |
| å akseptere at det ikke finnes snarveier | to accept that there are no shortcuts |
| Beklager bryderiet, men jeg oppdaget at … | Sorry to bother you, but I noticed that … |
| til gode                             | for the benefit of, in one's favour    |

- Hans rike erfaring kom oss til gode.  
  → We benefitted greatly from his rich experience.
- Tvilen skal komme tiltalte til gode.  
  → The benefit of the doubt shall go to the accused.


| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| Det skjedde bare en gang tidligere.  | It only happened once before.          |
| Helst snart enn senere.              | Preferably sooner rather than later.   |
| være verdt å ha i bakhånd            | be worth having/keeping in mind        |
| Hei! Jeg har bestilt bord for to personer i dag kl. 17.30. Bestillingen står på navnet …/ Reservasjonen er i navnet … | Hi! I have booked a table for two people today at 17:30. The reservation is under the name … |
...
| nydelig                              | lovely                                 |
| billig, billig, billige              | cheap, inexpensive                     |
| dyr, dyrt, dyre                      | expensive                              |
| kostbar, kostbart, kostbare          | costly, expensive                      |
...
| å <span class="env-green">stole **på**</span> noen   | to trust someone   |
| å <span class="env-green">stolt **av**</span> noe(n) | be proud of sth/sb |
...
| slå på/av ovnen/lyset                | turn on/off the oven/light             |
| å slå av en prat                     | to have a chat, chat casually          |
| å <span class="env-green">*utfylle*</span> hverandre | complement each other                  |
| å <span class="env-green">*oppfylle*</span> / *tilfredstille* et krav | to fulfill a requirement |
...
| forsvarlig / rimelig / fornuftig     | resonable                              |
| drosje                               | taxis                                  |
...
| visse + plural noun                  | certain …; can be used to replace «noen + plural n.» |
| å bebreide [bebrˈeˈide] noen for noe | to blame sb for sth                    |
| å orke ikke mer av tullet            | to not be able to take more of the nonsense |

tull, tullet → nonsense, rubbish, bullshit 无稽之谈，扯淡

| Norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| å etablere 注意挪威拼写中没有 «s»       | to e<span class="env-green">s</span>tablish |
...
| alltid                               | always                                 |
| sjelden                              | rarely                                 |
| en sjelden gang                      | once in a while                       |
| aldri                                | never                                  |
...
| norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| å formidle                           | to convey, to communicate              |

å formidle, formidler, formidlet, har formidlet

Læreren forsøker å **formidle** kunnskap til elevene.  
→ The teacher tries to convey knowledge to the students.

Jeg klarte ikke å **formidle** hva jeg mente.  
→ I couldn’t convey what I meant.

Boken **formidler** viktige verdier.  
→ The book conveys important values.
...
- Hun føler angst for framtiden.  
  → She feels anxiety about the future.
- Barnet utviklet angst for mørket.  
...
| norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| å være / bli <span class="env-green">opprørt</span> over noe | to be / get upset about sth; distressed, or deeply affected emotionally, often because of something unfair, shocking, or emotional. |

- Hun var *opprørt over* behandlingen hun fikk.  
  → She was upset about the treatment she received.
- Jeg *ble opprørt* over nyheten.  
...
| være <span class="env-green">lei av</span> noe(n) | be tired of sth/sb |
...
1.  embarrassed, ashamed 尴尬的，羞愧的
    ...
    - <span class="env-green">**bli flau for noe**</span>  → be embarrassed about something
...
| nervøs                               | nervous                                |
| irritert [iritˈert]                  | irritated 被激怒的                     |
| irritabel                            | irritable 易怒的，急躁的；             |
| irriterende                          | irritating 让人恼火的，烦人的          |
...
en følelese av *triumf* → a sense of triumph
...
en syk følelse → a crazy/intense/unreal feeling
...
- å føle noe (verb transitive) → to feel sth (physical or emotional sensation)
  ...
  后接<span class="env-green">名词</span>
  ...
  å føler enorm stolthet over noe → to feel enormous pride about sth  

  In spoken language, you often hear people say «føle på noe». «På» adds emotional emphasis.

- å føle seg (verb reflexive) → to feel oneself (state of being, emotional or physical condition)
  
  后接<span class="env-green">形容词</span>
...
- Hun kjenner på stress i hverdagen.  
  → She feels stress in everyday life.

- Han kjenner på mye glede for tiden.  
  → He is experiencing a lot of joy these days.
...
| norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| lynne(t)                             | temperament, disposition               |
| egenskap(en)                         | quality, nature, trait, characteristic 性格特点|
...
| <span class="env-green">punktlig</span> | punctual                    |
| troverdig / pålitelig                | reliable, credible, trustworthy        |
...
- en spøk, spøken, spøker, spøkene
- en vits, vitsen, vitser, vitsene
...
| plagsom                              | troublesome, annoying                  |
| <span class="env-green">urovekkende</span> | disturbing, worrying, troubling  |
...
Alle har rett til <span class="env-green">å handle etter sin egen frie vilje</span>. → Everyone has the right to act according to their own free will.
...
| dvs.         | det vil si                | that is, i.e., that means |
| osv.         | <span class="env-green">og så videre</span> | and so on |
| mm.          | med mer                   | and more, etc.            |
...
| mvh.         | med vennlig hilsen        | best regards              |
| vh.          | vennlig hilsen            | best regards              |
...
| å bære (to carry)              | bærer       | b<span class="env-green">a</span>r | har b<span class="env-green">å</span>ret |
| å innebære (to involve, entail) | innebærer  | innebar        | har innebåret         |

**å bare**

- Physically: to carry sth
  
  Jeg kan ikke *bære* alle posene alene.

  Han *bar* babyen forsiktig.

- Figuratively: to bear, endure, or put up with sth
  
  Hun måtte *bære* sorgen alene.  
  → She had to bear the grief alone.
  
  Som leder må du *bære* ansvaret for beslutningene dine.  
  → As a leader, you must bear responsibility for your decisions.

  Han må *bære* konsekvensene av sine handlinger.  
  → He must bear the consequences of his actions.

  å *bære* straffen → to bear the punishment

- **være båret av noe** → be carried by sth (literal or figurative)

  Han fortsatte, båret av minnene om familien.  
  → He continued, carried by the memories of his family.
  
  Med en følelse av triumf vendte de hjem, båret av minnene som ville vare livet ut.  
  → With a sense of triumph, they returned home, carried by memories that would last a lifetime.
...
| å foregå (to take place, happen) | foregår   | foregikk       | har foregått          |
| å angå (to concern, to be about) | angår     | angikk         | har angått            |
| å omgås (to associate with)    | omgås       | omgikkes       | har omgåttes          |

Det *angår* alle i samfunnet.  
→ It concerns everyone in society.
...
| å unnlate (to omit, fail to do) | unnlater   | unnlot         | har unnlatt           |
...
| å ligge (vi. 不及物)           | ligger      | <span class="env-green">lå</span> | har ligget |

- All makt over Danmark-Norge *lå* hos den danske kongen.  
  → All power over Denmark-Norway lay with the Danish king.

**-legge, -legger, -la, -lagt**

| **Infinitive**                 | **Presens** | **Preteritum** | **Presens Perfektum** |
| ------------------------------ | ----------- | -------------- | --------------------- |
| <span class="env-green">å legge</span> (vt. 及物) | legger | <span class="env-green">la</span> | <span class="env-green">har lagt</span> |
| å planlegge                    | planlegger  | planla         | har planlagt          |
| å pålegge (to require, impose, direct) | pålegger | påla      | har pålagt            |

«-lagt» adj.

**å pålegge noen å gjøre noe** → to require someone to do something

Politiet **påla** mannen å reparere bremsene.  
→ The police instructed the man to fix the brakes.

Staten har **pålagt** fylkene å kjøpe utslippsfrie busser.  
→ The government has required the counties to purchase emission-free buses.

pålagt adj. required, mandatory, imposed

opplagt adj. 1. obvious, clear 2. be fit, in the mood for sth 状态好


| **Infinitive**                 | **Presens** | **Preteritum** | **Presens Perfektum** |
| ------------------------------ | ----------- | -------------- | --------------------- |
| å hjelpe                       | hjelper     | hjalp          | har hjulpet           |
| å stjele                       | stjeler     | stj<span class="env-green">a</span>l | har stj<span class="env-green">å</span>let |
| å tilby                        | tilbyr      | <span class="env-green">tilbød</span> | har tilbudt |
...
| å sette | setter | s<span class="env-green">a</span>tte | har s<span class="env-green">a</span>tt |

**å bli satt ut av noe** → be shocked / stunned by sth

- Jeg ble helt satt ut av nyheten.  
  → I was completely stunned by the news.

- Hun ble satt ut da hun hørte resultatet.  
  → She was stunned when she heard the result.

区别于 **bli utsatt for noe** → be exposed to sth

Han ble utsatt for vold/diskriminering/rasisme/svindel.  
→ He was exposed to violence/discrimination/racism/fraud.


| **Infinitive**                 | **Presens** | **Preteritum** | **Presens Perfektum** |
| ------------------------------ | ----------- | -------------- | --------------------- |
| å innse (to realize)           | innser      | innså          | har innsett           |
| å sitter                       | sittter     | satt           | har sittet            |
| <span class="env-green">å stå</span> | står  | sto            | har stått             |
| å oppstå (to arise)            | oppstår     | oppsto         | har oppstått          |
| å motstå (to resist)           | motstår     | motsto         | har motstått          |
| <span class="env-green">å slå</span> (to hit, strike, punch, beat) | slår | slo | har slått |
| å anslå (to estimate)          | anslår      | anslo          | har anslått           |


å bli slått av noen → be beaten by someone

å bli slått av noe → be struck with sth (figuratively, shocked, surprised)

- Hun ble slått av likheten deres.  
  → She was struck by how alike they were.


| **Infinitive**                 | **Presens** | **Preteritum** | **Presens Perfektum** |
| ------------------------------ | ----------- | -------------- | --------------------- |
| å forslå (to suggest)          | foreslår    | foreslo        | har foreslått         |

| **Infinitive**                 | **Presens** | **Preteritum** | **Presens Perfektum** |
| ------------------------------ | ----------- | -------------- | --------------------- |
| å vite                         | vet         | vi<span class="env-green">ss</span>te  | har visst     |
| å vise                         | viser       | vi<span class="env-green">s</span>te   | har vist      |
| å innebære (to involve, imply) | innebærer   | innebar        | har innebåret         |
| å treffe (to meet)             | treffer     | traff          | har truffet           |
| å fryse                        | fryser      | <span class="env-green">frøs</span>    | har frosset   |
...
- å vare → v. to last, to endure
  ...
  Møtet <span class="env-green">varte</span> i to timer.  
  → The meeting lasted for two hours.

  Kurset <span class="env-green">har vart</span> i seks måneder.  
  → The course has lasted for six months.

- en vare → n. a product, an item

  Butikken selger mange forskjellige <span class="env-green">varer</span>.  
  → The store sells many different products.


| **Infinitive**                 | **Presens** | **Preteritum** | **Presens Perfektum** |
| ------------------------------ | ----------- | -------------- | --------------------- |
| å slite                        | sliter      | <span class="env-green">slet/sleit</span> | har <span class="env-green">slitt</span> |

- Jeg har slitt med + noen problemer siden …  
  → I have struggled with + some problems since …


| **Infinitive**                 | **Presens** | **Preteritum** | **Presens Perfektum** |
| ------------------------------ | ----------- | -------------- | --------------------- |
| å fortsette                    | fortsetter  | forts<span class="env-green">a</span>tte | har forts<span class="env-green">a</span>tt |
| å velge                        | velger      | v<span class="env-green">a</span>lgte | har v<span class="env-green">a</span>lgt |

et valg, valget, valg, valgene → n. a choice


| **Infinitive**                 | **Presens** | **Preteritum** | **Presens Perfektum** |
| ------------------------------ | ----------- | -------------- | --------------------- |
| å tilbringe                    | tilbringer  | tilbrakte      | har tilbrakt          |

- tilbringe tiden med å lese → spend time reading

  Vi må tilbringe natten på hotell.  
  → We have to spend the night at a hotel.

- Han <span class="env-green">lå</span> hele dagen. (不及物，He lay. = He stayed in the bed all day.)

  Hun <span class="env-green">la</span> boka på bordet. (及物，She put the book on the table.)

  Nemi <span class="env-green">har lagt</span> seg i kjelleren. (及物，Nemi has laid herself down in the basement.)
...
| å anta (to assume; adopt; estimate) | antar | antok | har antatt         |
| å gjenoppta (to resume) | gjenopptar | gjenopptok | har gjenopptatt      |

Hun sier at hun vil gjenoppta studiene etter sommeren. → She says she will resume her studies after the summer.

以 "-es" 结尾的动词，过去分词和过去式通常以 "-tes" 结尾

"-es" indicates reflexive or reciprocal action, "each other", e.g., å møtes/treffes → to meet each other

| **Infinitive**    | **Presens** | **Preteritum** | **Presens Perfektum** |
| ----------------- | ----------- | -------------- | --------------------- |
| å møtes | møtes | mø<span class="env-green">tt</span>es | har mø<span class="env-green">tt</span>es |
| å synes           | synes       | syntes         | har syntes            |
| å treffes         | treffes     | treftes        | har treftes           |
| å lykkes          | lykkes      | lyktes         | har lykkes/lyktes     |
| å ferdes (to roam, move about) | ferdes | ferdedes | har ferdes           |


**å møtes vs. å møte**

- å møtes → to meet/see each other; casual encounter, informal, or social meeting;

- å møte → to have a meeting; more formal;

| **Infinitive**    | **Presens** | **Preteritum**  | **Presens Perfektum** |
| ----------------- | ----------- | --------------  | --------------------- |
| å måtte           | må          | måtte           | har måttet            |
| å rekke           | rekker      | r<span class="env-green">a</span>kk | har r<span class="env-green">u</span>kket |
| å skjønne         | skjønner    | skjønte         | har skjønt            |
| å virke           | virker      | virket          | har virket            |
| å sikre           | sikrer      | sikret          | har sikret            |
| å selge           | selger      | s**o**lgte      | har s**o**lgt         |
| å glede           | gleder      | gled**et**      | har gledet            |
| å sørge           | sørger      | sørg**et**      | har sørget            |
| å fly (to fly)    | flyr        | fløy            | har fløyet            |
| å fly (to flee, escape) | flyr  | flydde          | har flydd             |
| å havne           | havner      | havn**et**      | har havnet            |
...
| å sove            | sover       | sov             | har sov**e**t         |



| **Infinitive**    | **Presens** | **Preteritum**  | **Presens Perfektum** |
| ----------------- | ----------- | --------------  | --------------------- |
| å opptre (perform, act) | opptrer | opptrådte     | har opptrådt          |
...
| å stige           | stiger      | st<span class="env-green">e</span>g | har steget |

et steg, steget, steg, stegene → a step
...
| å forfølge (persecute) | forfølger | forfulgte    | har forfulgt          |

å bli forfulgt → be persecuted
...
- **å bryte** → to break <span class="env-green">rules</span>, patterns, abstract notions

  å bryte loven/avtalen/vane → to break the law/agreement/habit

  reglene er brutt → the rules are broken

  Krig *brøt ut* i 2022.  
  → War broke out in 2022.

- **å brekke** → to break <span class="env-green">physically</span>, accidentally, often damage

  å brekke armen/beinet → to break one's arm/leg

- et utbrudd → an outbreak; explosion; eruption
  
  Vulkanen hadde et nytt utbrudd i år.  
  → Volcano had a new eruption this year.

- å avbryte → to interrupt, to cut off, to discontinue
  
  Han avbrøt møtet for å ta en telefon.  
  → He interrupted the meeting to take a phone call.


| **Infinitive**    | **Presens** | **Preteritum**  | **Presens Perfektum** |
| ----------------- | ----------- | --------------  | --------------------- |
| å skjelve (shake) | skjelver    | skalv           | har skjelvet          |

--------------------------------------------------------------------------------

### 动词分词作 adj.

«-ere» 结尾的动词，过去分词常以 «-ert» 结尾。可以 <span class="env-green">作形容词用</span>。

| **Infinitive**    | **Presens**   | **Preteritum**  | **Presens Perfektum** | -ende form      |
| ----------------- | ------------- | --------------  | --------------------- | --------------- |
| å organisere      | organiserer   | organiserte     | har organisert        | organiserende   |
| å diskriminere    | diskriminerer | diskriminerte   | har diskriminert      | diskriminerende |
| å inkludere       | inkluderer    | inkluderte      | har inkludert         | inkluderende    |
| å ekskludere      | ekskluderer   | ekskluderte     | har ekskludert        | ekskluderende   |
| å dominere        | dominerer     | dominerte       | har dominert          | dominerende     |
| å irritere        | irriterer     | irriterte       | har irritert          | irriterende     |
| å fungere vel     |               |                 |                       | velfungerende   |
| å resultere (i)   | resulterer    | resulterte      | har resultert         |                 |
| å røre            | rører         | rørte           | har rørt              | rørende (touching) |


| **Infinitive**    | **Presens**   | **Preteritum**  | **Presens Perfektum** | -ende form      |
| ----------------- | ------------- | --------------  | --------------------- | --------------- |
| å omfatte (to include) | omfatter | omfattet        | har omfattet          | omfattende      |

omfattende → comprehensive, extensive, wide-ranging

| **Infinitive**    | **Presens**   | **Preteritum**  | **Presens Perfektum** | -ende form      |
| ----------------- | ------------- | --------------  | --------------------- | --------------- |
| å grunnlegge      | grunnlegger   | grunnla         | har grunnlagt         | grunnleggende   |

**et grunnlag**, grunnlaget, grunnlag, grunnlagene → basis, foundation, groundwork

Han har *et got grunnlag* å bygge videre på.  
→ He has a good foundation to build on.

Seleskapet *ble grunnlagt* i 1990.  
→ The company was founded in 1990.

Dette er et grunnleggende prinsipp i økonomi.  
→ This is a fundamental principle in economics.

| **Infinitive**    | **Presens**   | **Preteritum**  | **Presens Perfektum** | -ende form      |
| ----------------- | ------------- | --------------  | --------------------- | --------------- |
| å kommandere      | kommenderer   | kommenderte     | har kommendert        | kommenderende   |
| å forbygge        | forbygger     | forbygget       | har forbygget         | forbyggende     |
| å avlyse          | avlyser       | avlyste         | har avlyst            |                 |
| å kansellere      | kansellerer   | kansellerte     | har kansellert        |                 |
| å øke             | øker          | økte            | har økt               | økende          |
| å gjelde          | gjelder       | gjeldet         | har gjeldet           | gjeldende       |
| å integrere       | integrerer    | integrerte      | har integrert         |                 |
| å avvise (to reject) | avviser    | avviste         | har avvist            | avvisende       |

avvist → rejected, turned down, dismissed

være redd for å bli avvist → be afraid of being rejected
 
avvisende → unsympathetic, distant, reserved

<span class="env-green">-ende form</span> 现在分词形式 (presens partisipp)，可以作形容词用，表示 «…的»，强调<span class="env-green">主动性</span>。没有性数变化。

ei **smilende** jente → ei jente som smiler  
en **troende** person → en person som tror på en gud  
noen **krevende** oppgaver → noen oppgaver som krever mye  
noen **demonstrerende** ungdommer → noen ungdommer som demonstrerer

> Presens partisipp (现在分词) har alltid sammen form og bøyes ikke.

| kjønn            | eksempel                           |
| ---------------- | ---------------------------------- |
| Han-/Hunkjønn    | Han trøstet den *gråtende* jenta.    |
| Intetkjønn       | Han trøstet det *gråtende* barnet.   |
| Flertall         | Han trøstet de *gråtende* barna.     |


| **Infinitive**    | **Presens**   | **Preteritum**  | **Presens Perfektum** | -ende form      |
| ----------------- | ------------- | --------------  | --------------------- | --------------- |
| å berolige (to calm) | beroliger  | beroliget       | har beroliget         | beroligende (reassuring, soothing, comforting) |



<span class="env-green">-ert form</span> 过去分词形式 (perfektum partisipp)，也可以作形容词用，表示 «被…的»，表<span class="env-green">被动</span>

<span class="env-green">**过去分词**</span>作形容词，形变类似于 adj.

- 单复数变形
- 根据特指非特指形变。特指以 «-e»，非特指用过去分词原型。
- 无性别变化

| Entall          | Flertall          | Bestemt entall        | Bestemt flertall      |
| --------------- | ----------------- | --------------------- | --------------------- |
| **stekt** fisk  | **stekte** fisker | den **stekte** fisken | de **stekte** fiskene |
| et **leid** hus | to **leide** hus  | det **leide** huset   | de **leide** husene   |

| -ende form        | -ert form          |
| ----------------- | ------------------ |
| et inkluderende samfunn (inclusive society)     | et inkludert samfunn (the society is included)          |
| en dominerende kultur (a dominating culture)    | en dominert kultur (the culture is dominated)           |
| en organisert aktivitet (an organized activity) | en organiserende aktivitet (the activity is organizing) |
...
«-el» 结尾的名词，复数常变为 «-ler»，特指复数以 «-lene» 结尾。 

| singular indefinite   | singular definite | plural indefinite   | plural definite |
| --------------------- | ----------------- | ------------------- | --------------- |
| eksemp<span class="env-green">el</span> | eksempelet | eksempel / eksempl<span class="env-green">er</span> | eksemplene |
| en terskel (threshold) | terskelen        | tersk <span class="env-green">ler</span> | tersklene |
| en bok                | boken             | bøker               | bøkene          |
| hånd                  | hånden            | hender              | hendene         |
| et øye                | øyet              | øyne                | øynene          |
| en ans<span class="env-green">a</span>tt | den ansatte | ansatt<span class="env-green">e</span> | de ansatte |

«Ansatt» comes from the verb «å ans<span class="env-green">e</span>tte» which means to employ or hire.
...
|                       |                   | klær                | klærne          |
| en ide                | ideen             | ideer               | ideene          |


--------------------------------------------------------------------------------

«<span class="env-green">-er</span>» 结尾的名词: 常表示人或职业。
复数非特指以 «<span class="env-green">-ere</span>» 结尾，复数特指以 «<span class="env-green">-erne</span>» 结尾。

| singular indefinite   | singular definite | plural indefinite   | plural definite |
| --------------------- | ----------------- | ------------------- | --------------- |
| en lær<span class="env-green">er</span> | læreren | lær<span class="env-green">ere</span> | lær<span class="env-green">erne</span> |
| en innvandr<span class="env-green">er</span> | innvandreren | innvandr<span class="env-green">ere</span> | innvandr<span class="env-green">erne</span> |
| en arbeidstak<span class="env-green">er</span>       | arbeidstakeren    | arbeidstak<span class="env-green">ere</span> | arbeidstak<span class="env-green">erne</span>  |
| en arbeidsgiv<span class="env-green">er</span>       | arbeidsgiveren    | arbeidsgiv<span class="env-green">ere</span> | arbeidsgiv<span class="env-green">erne</span>  |
| en report<span class="env-green">er</span>            | reporteren        | report<span class="env-green">ere</span>            | report<span class="env-green">erne</span>      |
| bruker                 | brukeren           | brukere              | brukerne         |
| forkjemper (advocate, supporter) | forkjemperen | forkjempere      | forkjemperne     |
| motstander (opponent)  | motstanderen       | motstandere          | motstanderne     |
| pendler (commuter)     | pendleren          | pendlere             | pendlerne        |
...
| et prinsipp         | prinsippet        | prinsipper        | prinsippene     |
| et firm<span class="env-green">**a**</span>  | firmaet | firma / firmaer | firmaene |
...
## Uregelrette Adjective

| mas./fem. singular | neuter singular | plural       |
| ------------------ | --------------- | ------------ |
| fri                | fritt           | frie         |
| vill               | vilt            | ville        |

- Vi skal til Afrika for å ta bilder av *ville* dyr. → We're going to Africa to take pictures of wild animals.


单数以 «-ell» 结尾的形容词，neuter 以 «-elt» 结尾, 复数以 «-elle» 结尾。

| mas./fem. singular | neuter singular | plural          |
| ------------------ | --------------- | --------------- |
| aktu<span class="env-green">ell</span> | aktu<span class="env-green">elt</span> | aktu<span class="env-green">elle</span> |
- Den *aktuelle* situasjonen er vanskelig.  
  → The current situation is difficult.

- Dette er en *aktuell* problemstilling.  
  → This is a relevant issue.

- Spørsmålet er fortsatt *aktuelt*.  
  → The question is still relevant.

- Han tok opp et *aktuelt* tema i møtet.
  → He raised a relevant topic in the meeting.

| mas./fem. singular | neuter singular | plural          |
| ------------------ | --------------- | --------------- |
| materiell          | materielt       | materielle      |
| intensjonell       | intensjonelt    | intensjonelle   |
...
- sånn: such, like that, that kind of



形容词比较级变形规则见<a href="{{site.baseurl}}/2024/02/18/Norsk-Grammar.html#adjektiv-komparativ">此处</a>。
...
Hva er <span class="env-green">best</span> for barna? → What is best for the children? [作表语用 «best»，挪英同形]

Dette er *best* for barna. → This is best for the children.

Jeg gjør mitt best<span class="env-green">e</span>. → I do my best. [注意 «beste» is definite form of superlative,  因为前面是 posessive pronoun «mitt»]

Note that <span class="env-green">«beste»</span> here is *bestemt form* (definite form) of superlative.

When used to describe a noun, use the definite form: <span class="env-green">posessive + beste + indefinite noun</span>

Han ga *sitt best<span class="env-green">e</span> forsøk*. → He gave his best attempt.
...
den beste løsningen → the best solution [三重一致 den/det/de + definite form of adj + definite form of noun]  
det beste alternativet → the best alternative [三重一致]
min beste venn → my best friend [前置 posessive pronoun，名词用非特指]
...
| mas./fem. singular | neuter singular | plural        | comparative | superlative      |
| ------------------ | --------------- | ------------- | ----------- | ---------------- |
| ille               | ille            | ille          | v<span class="env-green">e</span>rre | verst |
| morsom             | morsomt         | morso<span class="env-green">mm</span>e | morso<span class="env-green">mm</span>ere | morsomst |



| base               | comparative        | superlative       |
| ------------------ | ------------------ | ----------------- |
| dårlig             | verre / dårligere  | verst / dårligst  |
| stor 大            | større             | størst            |
| liten 小           | mindre             | minst             |

| mas.      | fem.      | neuter    | plural     | definite     |
| --------- | --------- | --------- | ---------- | ------------ |
| liten     | lita      | lite      | små        | lille        |

Den <span class="env-green">lille</span> forskjellen mellom … → The small difference among …


| base               | comparative        | superlative       |
| ------------------ | ------------------ | ----------------- |
| mye 多，不可数      | mer                | mest              |
| få 少，<span class="env-green">不可数</span> | færre | færrest |
| mange 多，可数      | flere              | flest             |
| liten 少，<span class="env-green">可数</span> | mindre | minst |
| gammel             | <span class="env-green">eldre</span> | eldst |
| ung                | yngre              | yngst             |
| lang (physical or duration), langt, lange  adj. | l<span class="env-green">e</span>ngre  | lengst |
| lenge (time)  adv. | lenger             | lengst            |

**lang, langt, lange** (adj.) 长

Det er en *lang* ventetid på dette sykehuset. → There is a long waiting time at this hospital.

Alle skulle kunne få medisinsk hjelp av høy kvalitet i rett tid, uten for *lang* ventetid. → Everyone should be able to get high-quality medical help in a timely manner, without too long waiting times.

Det har en *lang* kø på butikken. → There is a long queue at the store.

Hun har *langt* hår. → She has long hair. [physical]

Hennes hår er *lenger* enn mitt. → Her hair is longer than mine.

Du jobber en *lengre* <a href="#vakt"><span class="env-green">vakt</span></a> i dag. → You are working a longer *shift* today. [duration]

Bor du *langt* unna (fra jobben)? → Du you live far away (from work)?

--------------------------------------------------------------------------------

**lenge** (adv.) 无性数形变 很久

Han jobber ikke her *lenger*. → He doesn't work here *anymore*. 

Det er *lenge* siden sist. → It has been *a long time* since the last time.
...
| mas/fem           | neuter           | plural           |
| ----------------- | ---------------- | ---------------- |
| voksen            | voksent          | voks<span class="env-green">ne</span> |
| kjapp             | kjapt            | kjappe           |
...
| ------------- | ----------------------------------- |
| ideal         | idealt, ideale                      |
| trend         | trenden, trender, trendene          |
| å handle      | handler, handlet, har handlet       |
| mild          | mildt, milde                        |
| å fly         | flyr, fløy, har fløyet/flydd        |

å fly, flyr, fløy, har fløyet/flydd  → to fly

- Fuglen flyr.  
  → The bird flies.
- Vi fløy til Oslo i går.  
  → We flew to Oslo yesterday.
- Hun har fløyet mye i jobben sin.  
  → She has flown a lot in her job.


å fly, flyr, flydde, har flydd → to flee, to escape

- Tyven flydde fra politiet.  
  → The thief fled from the police.
- <span class="env-green">Tiden flyr.</span> 
  → Time flies.
- Hun har flydd rundt hele dagen.  
  → She has been running around all day.


| Base          | Bøyning                             |
| ------------- | ----------------------------------- |
| å guide       | guider, guidet, har guidet          |
| en guide      | guiden, guider, guidene             |
| solid         | solid, solide                       |
| en storm      | stormen, stormer, stormene          |

Huset er solid bygget. → The house is solidly built.

Det er en solid investering. → It is a solid investment.

Flyet er avlyst på grunn av snøstormen. → The flight is cancelled due to the snow storm.
...
| Base          | Bøyning                             |
| ------------- | ----------------------------------- |
| uniform       | uniformen, uniformer, uniformene    |
| brutal        | brutalt, brutale                    |
| mental        | mentalt, mentale                    |
| relevant      | relevant, relevante                 |
| en start      | starten, starter, startene          |
| service       | servicen                            |
...
1. customer service
   ...
   Butikken har veldig god service.  
   → The store has very good service.

2. technical maintenance 保养
   
   Bilen skal på service.  
   → The car needs to go in for servicing. 车保养


| Base          | Bøyning                             |
| ------------- | ----------------------------------- |
| diverse       | no bøyning, alle former er «diverse»|
...
| Norsk                               | English                  |
| ----------------------------------- | ------------------------ |
| kreativ, kreativt, kreative         | creative                 |
| innovativ                           | innovative               |
| produktiv                           | productive               |
| effektiv                            | effective                |
| primitiv                            | primitive                |
| effektivitet(en)                    | effectiveness            |
| effekt(en)                          | effect                   |
| komfortab<span class="env-green">el</span>, komfortabelt, komfortable | comfortable |
| et eksempel, eksempelet, eksempler, eksemplene | an example    |
| en plattform                        | a platform               |
| dobbelt, dobbelt, dobbelte          | double                   |

dobbelt [då´b:(ə)lt]

dobbelt så stor → twice as big



«-ere» 结尾的动词, 过去时 «-erte» 结尾，过去分词 «-ert» 结尾。

| Norsk                               | English                  |
| ----------------------------------- | ------------------------ |
| å risikere                          | to risk                  |
| å insistere                         | to insist                |
| å rekru<span class="env-green">tt</span>ere | to recruit       |
| å inspirere                         | to inspire               |
| å motivere                          | to motivate              |
| å etablere 注意挪威拼写中没有 «s»      | to e<span class="env-green">s</span>tablish |
| å evaluere                          | to evaluate              |
| å observere                         | to observe               |
| å tolerere                          | to tolerate              |

syn. å tåle → to tolerate, to endure, to bear

| Norsk                               | English                  |
| ----------------------------------- | ------------------------ |
| å insinuere                         | to insinuate 暗示，含沙射影 |



| Norsk                               | English                  |
| ----------------------------------- | ------------------------ |
| en respons                          | a response               |
| et resultat                         | a result                 |
| materiell(et)                       | material                 |


«-ell» 结尾的形容词，中性 «-elt» 结尾，复数和特指以 «-elle» 结尾。

| Norsk                               | English                  |
| ----------------------------------- | ------------------------ |
| profesjonell, profesjonelt, profesjonelle | professional       |
| tradisjonell, tradisjonelt, tradisjonelle | traditional        |
| spesiell, spesielt, spesielle       | special, specific        |
| offisiell, offisielt, offisielle    | official                 |
| <span class="env-green">generell</span>, generelt, generelle | general |



| Norsk                               | English                  |
| ----------------------------------- | ------------------------ |
| preferanse(n)                       | preference               |
| medalje(n)                          | medal 奖牌                |
| et aspekt                           | an aspect                |
| respekt(en)                         | respect                  |
| et perspektiv                       | a perspective            |
| en ressurs                          | a resource               |
| stabil, stabilt, stabile            | stable                   |
| en stereotyp                        | a stereotype             |
| isolasjon(en)                       | isolation                |
| sjanse(n)                           | chance                   |
| et firma, firmaet, firma, firmaene  | a company                |
| en suksess 只有一个 «k»              | a success                |
| fleksib<span class="env-green">el</span>, fleksibelt, fleksib<span class="env-green">le</span> | flexible |
| et budsjett, budsjettet, budsjett, budsjettene | a budget      |
| direkte, direkte, direkte           | direct                   |
| fascinerende                        | fascinating              |
| entusiasme(n)                       | enthusiasm               |

Hun viste stor entusiasme for saken. → She showed great enthusiasm for the cause.

| Norsk                               | English                  |
| ----------------------------------- | ------------------------ |
| primær, primært, primære            | primary, basic           |

primære menneskerettigheter → primary human rights
...
| å droppe                            | to drop                  |
| en triumf                           | a triumph                |
| å gro, gror, grodde, har grodd      | to grow                  |
| privilegert [privilegˈert]          | privileged               |
...
3. a narrative, an account 叙述，叙事
   
   - *Historien* Frp prøver å spre, om at vi trues av en form for masseinnvandring, er feil.  
     → The narrative that the Progress Party is trying to spread, about us being threatened by a form of mass immigration, is wrong.
...
| ------------------------ | --------------- | --------------------------- |
| å øke                    | økning          | økende                      |
| å utvikle                | utvikling       | utviklende, utviklet        |
| å forbedre               | forbedring      | forbedrende, forbedret      |
| å forklare               | forklaring      |                             |
| å avlyse                 | avlysning       | avlyst                      |
| å diskriminere           | diskriminering  |                             |
| å lagge mat              | matlaging       |                             |
| å rengjøre               | rengjøring      |                             |
| å organisere             | organisering    | organisert                  |
| å mestre                 | mestring        |                             |
| å inndele (divide up)    | inndeling (division; classification) |        |
| å krenke                 | krenking        |                             |
| å rivalisere (rival, compete) | rivalisering    |                        |
| å fremstille             | fremstilling    |                             |

**å fremstille**

1. make out, make to seem 使看起来像；把…描绘成；把…说成
   
   - Hun fremstilte moren sin som en engel.  
     → She made her mother out to be an angel.

2. portray, depict, represent 展示，描绘

   - Hun kritiserte hvordan media fremstilte innvandrere.  
     → She criticized how the media portrayed immigrants.

   - Hun er kritisk til medias fremstilling av innvandring.  
     → She is critical of the media's representation/portrayal of immigration.

| verb                     | noun            |
| ------------------------ | --------------- |
| å styrke (to enhance)    | styrking        |
...
| verb           | noun            | adjective (participle)      |
| -------------- | --------------- | --------------------------- |
| å henvende     | henvendelse     |                             |
| å oppleve      | opplevelse      |                             |
| å gjenta       | gjentakelse     | gjentakende, gjentatt       |
| å fornærme (to offend, insult, affront) | fornærmelse |        |
| å krenke 冒犯、伤害 (人) | krenkelse    |                      |

区别于形近词 å innskrenke → to restrict, to limit, to curtail 限制 (权利、自由等)

Dette innkrenker dine rettigheter. → This restricts your rights.

Loven innkrenker ytringsfriheten. → The law restricts freedom of speech.

| verb           | noun            |
| -------------- | --------------- |
| å advare       | advarsel        |

en advarsel → a warning (not doing sth)

et varsel → a notification, alert, warning


### Other suffixes

Suffixes that can be added to verbs to form nouns, often with a meaning related to the verb's action or result.

| Suffix  | Kjønn  | Example                                     |
| ------- | ------ | ------------------------------------------- |
| -eri    | et     | bakeri (å bake), maleri (å male), frieri (å fri) |
| -sjon   | en     | diskusjon (å diskutere), beslutning (å beslutte), organisasjon (å organisere) |
| -iker   | en     | alkoholiker (alkohol), logiker (logikk), musiker (musikk) |
| -sel    | en     | trivsel (å trives), hørsel (å høre)         |
| -het    | en     | frihet (fri), likhet (lik), kjærlighet (kjærlig) |
| -nad    | en     | søknad (å søke), kostnad (å koste)          |
| -tøy    | et     | kjøretøy (å kjøre), leketøy (å leke)        |
| -er     | en     | maler (å male), lærer (å lære), arbeider (å arbeide) |
| -dom    | en     | fattigdom (fattig), rikdom (rik), barndom (barn) |
| -skap   | en     | vennskap (en venn), galskap (galgal), vitenskap (å vite) |
| -trang  | en     | …强迫(症) likhetstrang; kontrolltrang (控制欲); kjøpetrang (购物欲); sparetrang (节约欲) |
| -fremende |      | helsefremmende (health-promoting), miljøfremmende (environmentally friendly) |

### Prefix

**«sær-»** → special, unique, particular; comes from «særlig»

| Norsk                 | English                  |
| --------------------- | ------------------------ |
| særinteresse          | special interest         |
| særnorsk              | unique to Norwegian      |

**«om-»** → 1. around, about, concerning; 2. re- (repetition, doing again)

| Norsk                 | English                   |
| --------------------- | ------------------------- |
| omverden              | the world around us       |
| omtale                | mention, reference        |
| omstilling            | restructuring, transition |
| omstart               | restart                   |


**«be-»** → makes the verb transitive or more formal; add intensity or emphasis; 

| Norsk                 | English                   |
| --------------------- | ------------------------- |
| å bevare              | to preserve               |
| å berøre              | to touch; to affect       |
| å bekrefte            | to confirm                |
| å beskytte            | to protect                |
| å berolige            | calm (down), quiet, soothe (om å trøste), reassure |


«-av» means a reduction, off, away, down

| Norsk                 | English                   |
| --------------------- | ------------------------- |
| å avlyse              | to cancel                 |
| å avskaffe            | to abolish                |
| å avbestille          | to cancel (an order)      |
...
| verb           | noun            | adjective (participle)      |
| -------------- | --------------- | --------------------------- |
| å ønske        | et ønske        | ønsket; uønsket (uønskete); |
| å minne        | et minne        |                             |
| å styrke       | en styrke (a power, force)      |             |



--------------------------------------------------------------------------------

**å svekke**, svekker, svekket, har svekket → to weaken, impair, undermine  
sv<span class="env-green">a</span>k, svakt, svake, svakere, svakest → weak, weaker, weakest


å bli svekket → to become weakened, deteriorate (bli dårligere)  
å svekke virkningen av noe → to weaken the effect of sth  

Sykdommen har svekket meg. → The illness has made me weak.  
Tilliten til ham er alvorlig svekket. → The trust in him has been seriously impaired.

--------------------------------------------------------------------------------

**å tenke** → to think

en tanke, t<span class="env-green">a</span>nken, tanker, tankene → a thought
...
- n. adult, grown-up
  ...
  en voksen, voksenen, <span class="env-green">voksne</span>, de voksne 

  Note «de voksne» is used for plural definite form.

--------------------------------------------------------------------------------

å støtte → to support

støtten → support, aid, assistance
...
Det er lov å gjøre noe. → It is legal to do something.

Det er *sol*. → It is sunny.

Det er *ro*. → It is calm.
...
| Norsk                                  | English                            |
| -------------------------------------- | ---------------------------------- |
| fritid(en)                             | leisure time                       |
| livsstil(en)                           | lifestyle                          |
| arbeidsplass(en)                       | workplace                          |
| kundeservice                           | costumer service                   |
| skjermetid                             | screen time                        |
...
| komfyr                                 | stove 炉灶                         |
| stekeovn                               | oven 烤箱                          |
| <span class="env-green">høyttaler</span> | speaker 音箱喇叭                 |
| hodetelefoner                          | headphones 头戴式耳机              |
| øretelefoner                           | earphones 入耳式耳机               |
| stiftemaskin                           | stapler 订书机                     |
| stifter                                | staples 订书钉                     |
| søppelbøtte, søppelkasse               | trash can 垃圾桶                   |
| skjøteledning, grenuttak, stikkontaktlist | power strip 插线板              |
| stikkontakt                            | power outlet, socket 插座          |

- Hvor er nærmeste stikkontakt?  
  → Where is the nearest power outlet?

| Norsk                                  | English                            |
| -------------------------------------- | ---------------------------------- |
| strømkabel                             | power cable 电源线                 |
| et ratt                                | a steering wheel 方向盘            |
...
| Norsk                                  | English                            |
| -------------------------------------- | ---------------------------------- |
| alpint                                 | alpine skiing 高山滑雪               |
| bortoverski / langrenn                 | cross-country skiing 越野滑雪        |
| skigåing                               | skiing 滑雪                         |
| å gå på ski                            | to go skiing                       |

Å gå opp *bratte bakker*, fjellsider og krysse store folketomme sletter gir i tillegg en mestringsfølelse.  
→ Going up steep hills, mountainsides and crossing large empty plains also gives a sense of mastery.

## 天气

| Norsk                                 | English                            |
| ------------------------------------- | ---------------------------------- |
| solskinn                              | sunshine 阳光                      |
| regn                                  | rain 雨                            |
| snø                                   | snow 雪                            |
| Det laver ned.                        | It’s snowing heavily.              |
| solrik                                | sunny 晴朗的                       |
| overskyet                             | cloudy 多云的                      |
| å hagle                               | to hail 下冰雹                     |
...
| være bekymret for noe                | be worried about something             |
| bekymringsfull                       | worrisome, concerning                  |
| et bryderi                           | a trouble, nuisance                    |


**å bry seg <span class="env-green">med</span> noe** → trouble, bother oneself with sth [often used in negative sentences]

Jeg bryr meg ikke med sånne problemer.  
→ I don't bother myself with such problems.

Hun bryr seg ikke med sladder.  
→ She doesn't bother herself with gossip.

bry oss **med** andre → engage ourselves with others, interact with others

bry oss **om** andre → care about others, be concerned about others

--------------------------------------------------------------------------------


**å bry seg <span class="env-green">om</span> noe** → to care about something, to be concerned about something
...
- Jeg *bryr* meg *om* deg.  
  ...
  <span class="env-green">Vi bør *bry* oss *om* hverandre.</span>  
...
- Jeg *bryr meg om* du har det bra.  
  → I care that you are doing well.
  
  Han *bryr seg om* hvordan det går med deg.  
  → He cares about how you are doing.

  Han *bryr seg om* at barna har det bra. 
  → He cares that the children are doing well.
...
**en bekymring:** worry, concern; anxiety; 担忧
...
**et bryderi:** bother, inconvenience, hassle; 麻烦 
...
- Han driver med sport på fritiden.  
  → He does sports in his free time.
- Hva driver du med?  
  → What do you do? (as in what is your occupation or main activity)

**å bedrive noe** → more formal than «å drive med noe», often used for more serious or professional activities

- De bedriver forskning.  
  → They conduct research.
- Han bedriver ulovlig virksomhet.  
  → He engages in illegal activities.
- Hva slags virksomhet bedriver de?  
  → What kind of business are they engaged in?

**å drive og gjøre noe** → to be doing sth (often used for ongoing or continuous actions)

- Hun driver og lager mat til festen.  
  → She is busy making food for the party.
- Vi driver og rydder huset før gjestene kommer.  
  → We are busy cleaning the house before the guests arrive.

Basically "å drive og gjøre noe" means "å gjøre noe"; the nuanced difference is that it emphasized the ongoing nature of the activity, "in the process of doing sth", slightly more informal and conversational than just "å gjøre noe".

--------------------------------------------------------------------------------

<a id="fa"></a>
<span class="env-green">**Få**</span>
...
<span class="env-green">få + infinitiv</span> → to be allowed to do sth; to get/let sb (to) do sth
...
<span class="env-green">få + past participle</span> →  

1. to have sth done; manage to get sth done
...
2. to get the opportunity to do sth (比较少见)

   Du får prøvd deg på eksamensoppgaver.  
   → You get to try out exam questions.
...
| norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| å få i gang noe                      | to get sth going                       |
...
Universitetet <span class="env-green">ber</span> alle ansatte <span class="env-green">om</span> å kunne undervise på norsk.

være <span class="env-green">pålagt</span> å gjøre noe → be required to do sth
...
Treneren <span class="env-green">lar</span> alltid bare de beste spille når det er kamp.

Treneren <span class="env-green">lot</span> ham ikke spille i andre omgang.
...
| norsk                                | English                                |
| ------------------------------------ | -------------------------------------- |
| Er det <span class="env-green">noe i veien for at</span> vi utsetter avtalen? | Is there anything to prevent us from postponing the agreement? |
...
Etter mange år i Norge har jeg <span class="env-green">skjønt</span> at … → After many years in Norway, I have realized that …
...
<span class="env-green">**å ta seg av**</span> →  *take care of*, *to deal with*, or *to handle*
...
**å <span class="env-green">handle</span>** (same spell in English)
...
**å <span class="env-green">behandle</span>**, behandler, behandlet, har behandlet → **to treat**, to handle
...
**å <span class="env-green">takle</span>** (to tackle, to deal with; [informal])l takler, taklet, har taklet
...
<span class="env-green">**å virke + adj**</span> → to seem, appear, look
...
- Det ser ut som om + 从句 … → It looks as if …
- Det fremstår som om + 从句 … → It appears as if …
  
  Han fremstår som veldig trygg. → He appears very confident.  
  Hun fremsto som rolig under intervjuet. → She appeared calm during the interview.  
  Byen fremstår som moderne og ren. → The city appears modern and clean.  
...
- virkelighet: n. reality
  ...
  <span class="env-green">i virkeligheten</span> → in reality 表转折

  Det høres bra ut, men *i virkeligheten* er det mye vanskeligere. → It sounds good, but in reality it is much more difficult.
  
  synm.: faktum, sannheten, realiteten

- påvirke: v. to influence, affect

--------------------------------------------------------------------------------

**Det virker <span class="env-green">som om</span>** … → It seems/appears <span class="env-green">as if</span> …

- Det virker som om det kommer til å regne i morgen.  
  → It seems as if it is going to rain tomorrow.
- Det virker som om han er lei seg.  
  → It seems as if he is sad.
- Det virker som om hun ikke forstår oppgaven.  
  → It seems as if she does not understand the assignment.
- Det virker som om ingen tenker på sine personlige interesser.  
  → It seems as if no one is thinking about their personal interests.
- Det virker som om det tar litt mer tid enn antatt.  
  → It seems as if it is taking a bit more time than expected.

synm.: 

- **Det ser ut som om** + 从句 … → It looks as if …
- Det føle<span class="env-green">**s**</span> som om … → It feels as if …
- Det *fremstår* … → It appears …
- Det *regnes* som om … → It is considered as if …
...
| **interessert** (adj) [interes'ert] | interested      | Hun <span class="env-green">er interessert i</span> språk.  |
...
**bli <span class="env-green">bevisst</span> på noe** → become aware of sth
...
<span class="env-green">å miste tråden</span> → to lose the thread (of a conversation or argument) 
...
nytte(n) → mas. 1. benefit, advantage; 2. utility, use

en nytte, nytten, nytter, nyttene

more useful phrases:

- få nytte av noe → benefit from sth
- til nytte for noen → for the benefit of sb
- ha/dra nytte av noe → make use of sth
- gjøre nytte for seg → make oneself useful

nyttig → useful [adj]

区别与形近词 «benytte» and «utnytte»:

- **benytte**: to make use of sth, to utilize sth; neutral, used in written language or official contexts.
  
  «Benytte noe» alone is more often used for **concrete things**, e.g., tools and resources.

  Du kan *benytte* denne inngangen.  
  → You can use this entrance.

  Passasjerer bes *benytte* nødutgangen.  
  → Passengers are asked to use the emergency exit.

  区别于 «**benytte seg av noe**»: 用于抽象的事物

  Du kan *benytte deg av* muligheten til å lære norsk.  
  → You can take advantage of the opportunity to learn Norwegian.

  Du kan *benytte deg av* tilbudet.  
  → You can take advantage of the offer.


- **utnytte**: to exploit, to take advantage of sth/sb; often has a negative connotation, implying taking unfair advantage of someone or something.
  
  Positive / neutral:

  Vi må *utnytte* ressursene bedre.  
  → We need to exploit the resources better.

  Selskapet *utnytter* ny teknologi.  
  → The company exploits new technology.

  Negative:

  Han *utnyttet* situasjonen.  
  → He took advantage of the situation.

  Arbeidere ble *utnyttet*.  
...
egenskap → characteristic, trait

区别于 kjennskap → knowledge, familiarity
...
den andre <span class="env-green">deltakeren</span> → the other participant
...
| være <span class="env-green">belastning</span> / byrde for | be a burden for |
| være avlastning for noen            | be a relief for sb                     |
| være til byrde for noen             | be a burden to sb                      |
| være til bry for                    | be a nuisance/bother to                |


å få glede av (å gjøre) noe → to get joy from (doing) sth; to enjoy (doing) sth

en byrde, byrden, byrder, byrdene → a burden

Han bærer en tung byrde på skuldrene sine.  
→ He carries a heavy burden on his shoulders.

Eldereomsorg kan være en byrde for staten.  
→ Elderly care can be a burden for the state.

--------------------------------------------------------------------------------

**i det minst<span class="env-green">e</span>** → at least


1. indicate minimum expectation (suggesting subtle criticism) or amount

   - Du må *i det minste* prøve.  
     → You must at least try.
   
   - Du kunne *i det minste* forklare hva **som** skjedde.  
     → You could at least explain what happened. [Note that "som" is used here to introduce a relative clause, referring to subject, cannot be omitted.]
   
   - Jeg trenger *i det minste* en time til å fullføre oppgaven.  
     → I need at least an hour to finish the assignment.

2. if nothing else, indicate a small positive aspect in a situation that is otherwise negative
...
**vil + at noen skal gjøre noe** → want sb to do sth

Slatten vil at du skal hjelpe ham.  
→ Slatten wants you to help him.

Jeg ønsker at du skal komme.  
...
2. to expose (sb) to sth
   
   Barn bør ikke *utsettes for* farlige situasjoner.  
   → Children should not be exposed to dangerous situations.

   De unge *utsettes for* mobbing.  
   → The young are exposed to bullying.
   
   Barn kan *være utsatt for* mobbing på skolen.  
    → Children can be exposed to bullying at school.
   
   Eldre mennesker kan *være utsatt for* svindel.  
    → Elderly people can be exposed to fraud.
...
| Intetkjønn      | et fersk<span class="env-green">t</span> brødet | et frisk<span class="env-green">t</span> pust |
...
- å oppføre seg → to behave (one's behavior, manners)
  ...
  Han oppfører seg alltid høflig.  
  → He always behaves politely.

  Nemi oppførte seg ordentlig når hun besøkte meg.  
  → Nemi behaved properly when she visited me.
...
- midlertidig → temporary, provisional (lasting for a limited time; not permanent) 临时的，暂时的
  ...
  Han har fått en midlertidig jobb.  
  → He has gotten a temporary job.

  区别于形近词 «imidlertid» adv. → however, nevertheless
...
- fortsatt → **adv.** still, yet, nevertheless (表示某事仍在继续或某种状态仍然存在)
  ...
  Note that «fortsatt» is also the past participle of «fortsette».
...
- å fortsette, fortsetter, fortsatte, har fortsatt → **verb.** to continue, to carry on (表示继续进行某事)
  ...
  Hun fortsatte å snakke selv om ingen lyttet.  
  → She continued to speak even though no one was listening.

  Vi fortsetter møtet etter lunsj.  
  → We will continue the meeting after lunch.

  Hun fortsetter å jobbe sent.  
...
**Meningsfull vs. Meningsfylt**

- Meningsfull → meaningful, significant (having meaning or purpose; important or worthwhile)
  
  et meningsfullt liv → a meaningful life

  Samtalen med henne var veldig meningsfull.  
  → The conversation with her was very meaningful (emotionally or philosophically).

- Meningsfylt → “filled with meaning”, emphasizes that something contains meaning or has significance.
  
  Vi trenger aktiviteter som gjør hverdagen meningsfylt  
  → We need activities that make everyday life meaningful.
...
- bort → adv. away, off, gone (indicates movement away from a place or position)
  
  Han gikk bort fra huset.  
  → He walked away from the house.

- borte → adv. gone, missing, away (indicates that something is no longer present or has disappeared)
...
- del → part (general piece of sth) 部分

  En stor del av budsjettet går til utdanning.  
  → A large part of the budget goes to education.

- andel → share, proportion (a part of a whole, often expressed as a percentage or fraction) 比重
  
  Kvinners andel av arbeidsstyrken har økt.  
...
- kunnskap → knowledge 知识

  Han har mye kunnskap om historie.  
  → He has a lot of knowledge about history.

- kjennskap → familiarity, acquaintance 熟悉，了解
  
  Jeg har god kjennskap til lokal kultur.  
  → I am familiar with the local culture.

  Jeg har god kjennskap til byen.  
  → I have good familiarity with the city.

  Han har ikke kjennskap til det nye systemet.  
  → He is not familiar with the new system.

--------------------------------------------------------------------------------

**problem vs. problemstilling**

- et problem → a problem (a difficulty or issue that needs to be addressed)

  Vi har et problem med datamaskinen.  
  → We have a problem with the computer.

- en problemstilling → a problem statement, issue, question (a specific question or issue that is being investigated or discussed)
...
- lenger → adv. comparative of "lenge", for a longer time (indicates duration of time)
  ...
  Jeg skal ikke bli borte *lenger* enn en uke.  
  → I won't be gone for longer than a week.

  <span class="env-green">anymore, any longer</span> (used in negative sentences to indicate that something is no longer the case)
...
- lengre → adv. longer (comparative form of "lang", indicates a greater <span class="env-green">length</span> or <span class="env-green">duration</span>; sth physical or measurable)
  
  lang, lengre, lengst

  Veien er *lengre* enn jeg trodde.  
  → The road is longer than I thought. [physical length]

  Filmen var *lengre* enn jeg forventet.  
  → The movie was longer than I expected. [duration]

  Hun har *lengre* erfaring enn meg.  
  → She has more experience than me. [duration]

--------------------------------------------------------------------------------

**flere vs. mange**

Both can be used as subject to indicate "several people." "Mange" indicates a *larger* number of people than "flere." 

- **flere** → more, several (some people, maybe more than expected)
  
  Flere kom på festen.  
  → Several came to the party.

- **mange** → many (a large number of people); more than "flere"
  
  Mange kom på festen.  
  → Many came to the party. (a lot of people)

--------------------------------------------------------------------------------

**tydelig vs tidlig**

- tydelig → clear, obvious, distinct
- tidlig → early 
...
**forverre vs. forverres**

**forbedre vs. forbedres**

- «forverre» and «forbedre» indicate active sense, 后面要接宾语，表示「…使…变得更糟/更好」
  
  Stress kan *forverre* helsen.  
  → Stress can worsen health.
  
  Trening kan *forbedre* humøret.  
  → Exercise can improve mood.

  Dårlig vær *forverret* situasjonen.  
  → Bad weather worsened the situation.

  Tiltaket skal *forbedre* forholdene / arbeidsmiljøet for de ansatte.  
  → The measure is intended to improve conditions / work environment for the employees.

  Reflexive form: «<span class="env-green">**forverre/forbedre seg**</span>» → 主动表被动

  Helse **forverrer seg** av stress.  
  → Health is worsened by stress.

  Humør **forbedrer seg** av trening.  
  → Mood is improved by exercise.
  
  Situasjon **forverret seg** av dårlig vær.  
  → The situation was worsened by bad weather.

- «forverres» and «forbedres» indicate passive sense, 后面不接宾语，表示「…变得更糟/更好」
  
  A more natural translation is: getting worse/better; becoming worse/better.

  Helsen *forverres* av stress.  
  → Health is worsened by stress.

  Humøret *forbedres* av trening.  
  → Mood is improved by exercise.

  Situasjonen *forverres* av dårlig vær.  
  → The situation is worsened by bad weather.

  Forholdene / arbeidsmiljøet for de ansatte skal *forbedres* av tiltaket.  
  → Conditions / work environment for the employees will be improved by the measure.

  «av noe» is optional; used to introduce the cause or reason for the worsening/improvement.


--------------------------------------------------------------------------------


**virkning vs. innvirkning**

- virkning(en) → effect
  
  Tiltaket hadde liten virkning.  
  → The measure had little effect.

  Tiltakene har en positiv virkning på de ansattes helse.  
  → The measures have a positive effect on the employees' health. [specific effect]

  Tiltakene har positiv virkning på de ansattes helse.  
  → More general.

- innvirkning(en) → impact, influence
  
  Arbeidsmiljøet har stor innvirkning på sykefraværet.  
  → The work environment has a big impact on sick leave.

- påvirkning(en) → influence, effect
  


--------------------------------------------------------------------------------

**rapport vs reportasje**

- en rapport → a report
- en reportasje → a news report, a feature story (a detailed account of an event or topic, often with personal observations and interviews) 专题报道

--------------------------------------------------------------------------------

**erkjenne vs anerkjenne vs gjenkjenne**

- erkjenne → to admit, to acknowledge (to accept or admit the truth or existence of something)

  Han erkjente at han hadde gjort en feil.  
  → He admitted that he had made a mistake.

  Hun erkjente at hun ikke visste svaret.  
  → She acknowledged that she did not know the answer.

- annerkjenne → to recognize, to acknowledge, give credit to (to recognize the value, importance)
  
  Hun er en anerkjent forsker.  
  → She is a recognized researcher.

  Vi må anerkjenne innsatsen hans.  
  → We must acknowledge his efforts.

- gjenkjenne → to recognize (to identify someone or something from previous encounters or knowledge)
  
  Jeg gjenkjente ham med en gang.  
  → I recognized him immediately.

  De eldre er dårligst til å gjenkjenne falske nyheter.  
  → The elderly are worst at recognizing fake news.

  Det er utfordrende å gjenkjenne ansikter fra forskjellige etniske grupper.  
  → It is challenging to recognize faces from different ethnicity. 

--------------------------------------------------------------------------------

**mot vs. imot**

- mot: physical direction: against, towards
  
  Han kjørte *mot* byen.  
  → He drove towards the city.

- imot: against (opinion / stance)
  
  Jeg er *imot* dette forslaget.  
  → I am against this proposal. (opinion)
  
  Subtle difference:

  Han stemte *mot* forslaget.  
  → He voted against the proposal. (physical action of voting)
...
- nekte → to refuse, to deny (to refuse to do something or to allow something)
  
  Han nektet å hjelpe.  
  → He refused to help.

  Hun nektet å gå på festen.  
  → She refused to go to the party.

- benekte → to deny (to deny the truth or existence of something)
  
  Han benektet at han hadde gjort noe galt.  
  → He denied that he had done anything wrong.

  Hun benektet at hun visste noe om saken.  
  → She denied that she knew anything about the matter.

--------------------------------------------------------------------------------

**liten vs. litt**

- liten → little (indicating negative)
  
  Jeg har liten kontakt med henne.  
  → I have little contact with her.

  Han viser liten interesse for sporten.  
  → He shows little interest in sports.

  Det er liten forskjell mellom de to modellene.  
  → There is little difference between the two models.

  **knapt** → hardly, barely (almost none, positive but extremely small amount)

  De kjente ham knapt.  
  → They hardly knew him.
  
  Hun hadde knapt tid til å spise.  
  → She barely had time to eat. (She does not have much time to eat)

- litt → some, a little, a bit (indicating positive, but small amount)
  
  Jeg har litt kontakt med henne.  
  → I have some contact with her.

  Han viser litt interesse for sporten.  
  → He shows a little interest in sports.

  Det er litt forskjell mellom de to modellene.  
  → There is some difference between the two models.
