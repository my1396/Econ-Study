...
«-ere» 结尾的动词，过去分词常以 «-ert» 结尾。可以 <span class="env-green">作形容词用</spang。
...
| å diskriminere    | diskriminerer| diskriminerte  | har diskriminert      | 
...
-ende form 现在分词形式，可以作形容词用，表示 «…的»，强调主动性

-ert form 过去分词形式，也可以作形容词用，表示 «被…的»，表被动
