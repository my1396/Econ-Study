...
| mye 多，不可数      | mer                | mest              |
| få 少，不可数       | færre              | færrest           |
| mange 多，可数      | flere              | flest             |
| få 少，可数         | færre              | færrest           |
...
<span class="env-green">få + past participle</span> → to have sth done; manage to get sth done
