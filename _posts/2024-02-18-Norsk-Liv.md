...
Note "krefter" is the plural of "kraft" which means "power, strength, energy, effort". "Krefter" is used as a (uncountable) mass noun, so we say "<span style="color: #00CC66;">mye krefter</span>" (a lot of effort) rather than "<s>mange krefter</s>" (many efforts).
