...
«<span class="env-green">-er</span>» 结尾的名词: 复数非特指以 «<span class="env-green">-ere</span>» 结尾，复数特指以 «<span class="env-green">-erne</span>» 结尾。
...
| ung                | yngre              | yngst             |
| lang (physical or duration) | l<span class="env-green">e</span>ngre  | lengst |
| lenge (time)       | lenger             | lengst            |
