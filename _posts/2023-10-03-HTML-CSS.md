...
- **Pseudo-class Selector**
  A pseudo-class selector applies CSS to a selected element or elements <span style='color:#00CC66'>only when in a special state</span>. For example, `:hover` will only style an element when a user hovers over it. 
