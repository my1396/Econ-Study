...
`style` attribute specifies an <span style='color:#008B45'>**inline style**</span> for an element, such as color, font, size. It allows you to specify multiple attributes at one time. It is equivalent to use `font-size="12px"`. 冒号赋值，分号分隔 properties。
