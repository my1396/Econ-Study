...
Save as svg file: Right click on the symbol, select "Copy Image As", then choose "SVG", set "Point Size" to 1000 to get a high resolution svg file. Then you can use the svg file in your webpage.
