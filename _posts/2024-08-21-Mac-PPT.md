...
A: To change the Notes text size: go to **View** tab in the top ribbon > **Notes Master** and change the font size there. I set the font size to **20 pt** (defaults to **12 pt**). When you close the Notes Master view, the notes text size in Normal view will be updated.
