...
A: Use two fingers (or ⌘ and +/-) to zoom in on the notes area. This only change the display size, not the actual font size. If you want to change the actual font size, you need to go to Notes Master view.

To change the actual Notes text size: go to **View** tab in the top ribbon > **Notes Master** and change the font size there. I set the font size to **20 pt** (defaults to **12 pt**). When you close the Notes Master view, the notes text size in Normal view will be updated.

<img src="{{site.baseurl}}/images/ppt notes master.png" alt="" style="display: block; margin-right: auto; margin-left: auto; zoom:80%;" />

Note that <span class="env-green">12 pt is optimal for printing</span>, but too small for reading on screen. <span class="env-green">18 / 20 pt is good for reading on screen</span>, but too large for printing. → Toggle font size between 12 pt and 20 pt depending on your purpose.
...
You can print your slides with speaker notes. 

You may want to specify your note size to 12 pt in the Notes Master view first. 

⌘P to open the print window > **PowerPoint Layout** dropdown menu > Choose "**Notes**"

<img src="{{site.baseurl}}/images/ppt print with notes.png" alt="" style="display: block; margin-right: auto; margin-left: auto; zoom:80%;" />
...
Choose "Orientation: **Landscape**" and "Double-sided: <span class="env-green">On (Short Edge)</span>". Otherwise, will turn on long edge by default.

<img src="{{site.baseurl}}/images/ppt print 4-in-1.png" alt="" style="display: block; margin-right: auto; margin-left: auto; zoom:80%;" />
...
Q: How to remove Acrobat add-in?  
A: Tools > PowerPoint Add-ins ... > Select the Adobe add-in from the list and click the minus sign (-) to remove it.

Q: How to use the equation editor in PowerPoint?  
A: Refer to <a href="{{site.baseurl}}/2024/08/21/Mac-Word.html#ppt-multi-line-equations">this page</a>.
