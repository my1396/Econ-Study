...
Q: 有没有什么缺点呢？\
A: VS Code Snippets 好像有点儿问题。用中文输入法的便捷换取一点 bug.
...
2. 然后进入 settings -> keyboard -> All Input Sources，点击左下角的 + 号，选择「Chinese, Simplified」，然后选择「鼠鬚管」或者 Squirrel - Simplified，点击「添加」。
