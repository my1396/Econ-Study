...
schema_list:
  ...
  - schema: luna_pinyin_fluency # 明月拼音 语流
  - schema: bopomofo            # 注音
...
- [Rime 配置文件：补丁](https://github.com/rime/home/wiki/Configuration#補靪)
- [引擎与功能组件解读](https://github.com/rime/home/wiki/RimeWithSchemata#輸入法引擎與功能組件)
...
Q: 输入词语之后，想单独选字，如何操作？ \
A: 使用左右方向键移动光标，移到想要选择的字的位置，就会出现对应的单字候选。
