...
With MPE, you can export your markdown file as PDF. → Good for <span class="env-green">E-reader</span>.
...
This approach is fast. With TOC. 中文标点很奇怪。

___

Alternatively, for best paper quality, you can use Markdown PDF (by yzane) extension to export PDF. → Good for <span class="env-green">printing</span>.
