...
.markdown-preview.markdown-preview {
  ...
  &.prince {
    ...
    // Hide print-note class in prince pdf
    .print-note {
      display: none;
    }
  }
...
Fix: Use a font that supports both English and Chinese characters. For example, `font-family: 'Noto Sans CJK SC'`.
