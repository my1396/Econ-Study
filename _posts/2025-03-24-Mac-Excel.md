...
[How do I set default zoom in Excel 2019?](https://answers.microsoft.com/en-us/msoffice/forum/all/how-do-i-set-default-zoom-in-excel-2019/334f9386-758c-4747-9390-69c611d05197)

[Excel 2010 - Set default zoom setting](https://learn.microsoft.com/en-us/archive/msdn-technet-forums/a1f4d7b0-2f68-4f05-a673-717467141c5e)

[How to make Excel to open to a pre-defined zoom level](https://learn.microsoft.com/en-us/answers/questions/715252/how-to-make-excel-to-open-to-a-pre-defined-zoom-le)
...
Q: How to remove filter arrows in Excel Mac?  
A: Go to the **Data** tab, then in the "Sort & Filter" section, click **Clear**. If `Clear` is grayed out, the worksheet may be protected. Go to the **Review** tab and click "Unprotect Sheet".
