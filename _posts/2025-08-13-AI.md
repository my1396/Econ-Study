...
| ------- | ----- | ---- | ------ | ----- |
| Description| Next-generation intelligence for long-running agents | For complex agentic research and enterprise work | Balance of speed and intelligence; general purpose | Fastest, simplest, and most cost-effective |
...
Issue: Claude Code chat box does not render **LaTeX equations** properly.  
Fix: Use [Claude Code LaTeX](https://marketplace.visualstudio.com/items?itemName=nuriyev.claude-code-katex).
...
<tbody>
<tr>
<td><img width="505" alt="Before — raw LaTeX source in a chat response" src="https://github.com/user-attachments/assets/4813f18c-fcaa-419f-a636-a8c3651f8ec4"></td>
<td><img width="503" alt="After — the same response with rendered math" src="https://github.com/user-attachments/assets/a26b6b99-9e0c-4643-8467-549134068ee4"></td>
</tr>
</tbody>
</table>
...
The prices below do NOT include VAT (Value Added Tax). If you are in Norway, you will be charged 25% VAT on top of the prices below.


| Plan             | Free           | Pro               | Max 5x                 | Max 20x                       |
| ---------------- | -------------- | ----------------- | ---------------------- | ----------------------------- |
| Price  | $0  | <span class="env-green">$20/month</span> | $100  | $200   |
...
- Use a virtual US card for lower tax than in Norway. E.g., [grey.co](https://grey.co)
  ...
  This virtual card will give you the possibility to use US tax rates (0 -- 10%) instead of the Norwegian tax rate (25%). 
...
- Top up your linked wallet before making payments.
  ...
  Do NOT need to top up the Grey Visa card itself.
...
Regular bank card → [Revolut](https://www.revolut.com) → Grey wallet → Claude

Q: How to top up Revolut?  
A: In the home page of Revolut app, tap `Add money` and follow the instructions there.

Q: How to top up Grey wallet from Revolut?  
A: In the Revolut app, tap `Payments`, you will see your Grey wallet as a contact. Tap it and follow the instructions to top up your Grey wallet.
